...
import aiohttp
import yarl
from typing import Any, Callable, Coroutine, Dict, List, NamedTuple, Optional, TYPE_CHECKING, Tuple, TypeVar
...
class DiscordWebSocket:
    ...
    @classmethod
    async def from_client(cls, client: Client, *, initial: bool = ..., gateway: Optional[yarl.URL] = ..., shard_id: Optional[int] = ..., session: Optional[str] = ..., sequence: Optional[int] = ..., resume: bool = ..., encoding: str = ..., zlib: bool = ...) -> Self:
...
class DiscordVoiceWebSocket:
    ...
    @classmethod
    async def from_connection_state(cls, state: VoiceConnectionState, *, resume: bool = ..., hook: Optional[Callable[..., Coroutine[Any, Any, Any]]] = ...) -> Self:
