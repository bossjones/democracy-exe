...
from typing import Any, AsyncIterator, Callable, Dict, List, Optional, Protocol, Sequence, TYPE_CHECKING, TypeVar, Union, overload, runtime_checkable
...
class GuildChannel:
    ...
    async def set_permissions(self, target: Union[Member, Role], *, overwrite: Any = ..., reason: Optional[str] = ..., **permissions: Optional[bool]) -> None:
        r"""|coro|
