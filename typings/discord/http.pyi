...
from .types import appinfo, audit_log, automod, channel, command, emoji, guild, integration, invite, member, message, poll, role, scheduled_event, sku, sticker, template, threads, user, webhook, welcome_screen, widget
...
class HTTPClient:
    ...
    def get_reaction_users(self, channel_id: Snowflake, message_id: Snowflake, emoji: str, limit: int, after: Optional[Snowflake] = ..., type: Optional[message.ReactionType] = ...) -> Response[List[user.User]]:
        ...
    ...
    def bulk_ban(self, guild_id: Snowflake, user_ids: List[Snowflake], delete_message_seconds: int = ..., reason: Optional[str] = ...) -> Response[guild.BulkBanUserResponse]:
        ...
    ...
    def edit_voice_channel_status(self, status: Optional[str], *, channel_id: int, reason: Optional[str] = ...) -> Response[None]:
        ...
    ...
    def get_poll_answer_voters(self, channel_id: Snowflake, message_id: Snowflake, answer_id: Snowflake, after: Optional[Snowflake] = ..., limit: Optional[int] = ...) -> Response[poll.PollAnswerVoters]:
        ...
