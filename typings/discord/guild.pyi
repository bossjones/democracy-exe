...
import datetime
from typing import AsyncIterator, ClassVar, Collection, Dict, Iterable, List, Literal, Mapping, NamedTuple, Optional, Sequence, TYPE_CHECKING, Tuple, Union, overload
...
from .enums import AuditLogAction, AutoModRuleEventType, ContentFilter, EntityType, ForumLayoutType, ForumOrderType, Locale, MFALevel, NotificationLevel, PrivacyLevel, VerificationLevel, VideoQualityMode
...
class Guild(Hashable):
    ...
    async def create_text_channel(self, name: str, *, reason: Optional[str] = ..., category: Optional[CategoryChannel] = ..., news: bool = ..., position: int = ..., topic: str = ..., slowmode_delay: int = ..., nsfw: bool = ..., overwrites: Mapping[Union[Role, Member], PermissionOverwrite] = ..., default_auto_archive_duration: int = ..., default_thread_slowmode_delay: int = ...) -> TextChannel:
        """|coro|
    ...
    async def create_stage_channel(self, name: str, *, reason: Optional[str] = ..., category: Optional[CategoryChannel] = ..., position: int = ..., bitrate: int = ..., user_limit: int = ..., rtc_region: Optional[str] = ..., video_quality_mode: VideoQualityMode = ..., overwrites: Mapping[Union[Role, Member], PermissionOverwrite] = ...) -> StageChannel:
        """|coro|
    ...
    async def create_forum(self, name: str, *, topic: str = ..., position: int = ..., category: Optional[CategoryChannel] = ..., slowmode_delay: int = ..., nsfw: bool = ..., overwrites: Mapping[Union[Role, Member], PermissionOverwrite] = ..., reason: Optional[str] = ..., default_auto_archive_duration: int = ..., default_thread_slowmode_delay: int = ..., default_sort_order: ForumOrderType = ..., default_reaction_emoji: EmojiInputType = ..., default_layout: ForumLayoutType = ..., available_tags: Sequence[ForumTag] = ...) -> ForumChannel:
        """|coro|
    ...
    @overload
    async def create_scheduled_event(self, *, name: str, start_time: datetime.datetime, entity_type: Literal[EntityType.external] = ..., privacy_level: PrivacyLevel = ..., location: str = ..., end_time: datetime.datetime = ..., description: str = ..., image: bytes = ..., reason: Optional[str] = ...) -> ScheduledEvent:
        ...
    
    @overload
    async def create_scheduled_event(self, *, name: str, start_time: datetime.datetime, entity_type: Literal[EntityType.stage_instance, EntityType.voice] = ..., privacy_level: PrivacyLevel = ..., channel: Snowflake = ..., end_time: datetime.datetime = ..., description: str = ..., image: bytes = ..., reason: Optional[str] = ...) -> ScheduledEvent:
        ...
    
    @overload
    async def create_scheduled_event(self, *, name: str, start_time: datetime.datetime, privacy_level: PrivacyLevel = ..., location: str = ..., end_time: datetime.datetime = ..., description: str = ..., image: bytes = ..., reason: Optional[str] = ...) -> ScheduledEvent:
        ...
    
    @overload
    async def create_scheduled_event(self, *, name: str, start_time: datetime.datetime, privacy_level: PrivacyLevel = ..., channel: Union[VoiceChannel, StageChannel] = ..., end_time: datetime.datetime = ..., description: str = ..., image: bytes = ..., reason: Optional[str] = ...) -> ScheduledEvent:
        ...
    ...
    async def ban(self, user: Snowflake, *, reason: Optional[str] = ..., delete_message_days: int = ..., delete_message_seconds: int = ...) -> None:
        """|coro|
    ...
    async def bulk_ban(self, users: Iterable[Snowflake], *, reason: Optional[str] = ..., delete_message_seconds: int = ...) -> BulkBanResult:
        """|coro|
    ...
    async def create_automod_rule(self, *, name: str, event_type: AutoModRuleEventType, trigger: AutoModTrigger, actions: List[AutoModRuleAction], enabled: bool = ..., exempt_roles: Sequence[Snowflake] = ..., exempt_channels: Sequence[Snowflake] = ..., reason: str = ...) -> AutoModRule:
        """|coro|
