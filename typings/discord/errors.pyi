...
__all__ = ('DiscordException', 'ClientException', 'GatewayNotFound', 'HTTPException', 'RateLimited', 'Forbidden', 'NotFound', 'DiscordServerError', 'InvalidData', 'LoginFailure', 'ConnectionClosed', 'PrivilegedIntentsRequired', 'InteractionResponded')
