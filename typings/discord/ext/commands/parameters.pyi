...
class Parameter(inspect.Parameter):
    ...
    """
    __slots__ = ...
    def __init__(self, name: str, kind: ParamKinds, default: Any = ..., annotation: Any = ..., description: str = ..., displayed_default: str = ..., displayed_name: str = ...) -> None:
        ...
    
    def replace(self, *, name: str = ..., kind: ParamKinds = ..., default: Any = ..., annotation: Any = ..., description: str = ..., displayed_default: Any = ..., displayed_name: Any = ...) -> Self:
        ...
...
def parameter(*, converter: Any = ..., default: Any = ..., description: str = ..., displayed_default: str = ..., displayed_name: str = ...) -> Any:
...
class ParameterAlias(Protocol):
    def __call__(self, *, converter: Any = ..., default: Any = ..., description: str = ..., displayed_default: str = ..., displayed_name: str = ...) -> Any:
        ...
