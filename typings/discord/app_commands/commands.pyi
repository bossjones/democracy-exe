...
__all__ = ('Command', 'ContextMenu', 'Group', 'Parameter', 'context_menu', 'command', 'describe', 'check', 'rename', 'choices', 'autocomplete', 'guilds', 'guild_only', 'dm_only', 'private_channel_only', 'allowed_contexts', 'guild_install', 'user_install', 'allowed_installs', 'default_permissions')
if TYPE_CHECKING:
    P = ParamSpec('P')
else:
    ...
...
class Command(Generic[GroupT, P, T]):
    ...
    extras: :class:`dict`
        ...
        The library will not touch any values or keys within this dictionary.
    """
    def __init__(self, *, name: Union[str, locale_str], description: Union[str, locale_str], callback: CommandCallback[GroupT, P, T], nsfw: bool = ..., parent: Optional[Group] = ..., guild_ids: Optional[List[int]] = ..., allowed_contexts: Optional[AppCommandContext] = ..., allowed_installs: Optional[AppInstallationType] = ..., auto_locale_strings: bool = ..., extras: Dict[Any, Any] = ...) -> None:
        ...
...
class ContextMenu:
    ...
    extras: :class:`dict`
        ...
        The library will not touch any values or keys within this dictionary.
    """
    def __init__(self, *, name: Union[str, locale_str], callback: ContextMenuCallback, type: AppCommandType = ..., nsfw: bool = ..., guild_ids: Optional[List[int]] = ..., allowed_contexts: Optional[AppCommandContext] = ..., allowed_installs: Optional[AppInstallationType] = ..., auto_locale_strings: bool = ..., extras: Dict[Any, Any] = ...) -> None:
        ...
...
class Group:
    ...
    __discord_app_commands_contexts__: Optional[AppCommandContext] = ...
    __discord_app_commands_installation_types__: Optional[AppInstallationType] = ...
    ...
    def __init__(self, *, name: Union[str, locale_str] = ..., description: Union[str, locale_str] = ..., parent: Optional[Group] = ..., guild_ids: Optional[List[int]] = ..., guild_only: bool = ..., allowed_contexts: Optional[AppCommandContext] = ..., allowed_installs: Optional[AppInstallationType] = ..., nsfw: bool = ..., auto_locale_strings: bool = ..., default_permissions: Optional[Permissions] = ..., extras: Dict[Any, Any] = ...) -> None:
        ...
...
def private_channel_only(func: Optional[T] = ...) -> Union[T, Callable[[T], T]]:
...
def dm_only(func: Optional[T] = ...) -> Union[T, Callable[[T], T]]:
...
def allowed_contexts(guilds: bool = ..., dms: bool = ..., private_channels: bool = ...) -> Callable[[T], T]:
...
def guild_install(func: Optional[T] = ...) -> Union[T, Callable[[T], T]]:
...
def user_install(func: Optional[T] = ...) -> Union[T, Callable[[T], T]]:
...
def allowed_installs(guilds: bool = ..., users: bool = ...) -> Callable[[T], T]:
