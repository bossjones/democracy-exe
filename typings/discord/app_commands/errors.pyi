...
from ..errors import DiscordException, HTTPException
...
class TransformerError(AppCommandError):
    ...
    """
    def __init__(self, value: Any, opt_type: AppCommandOptionType, transformer: Transformer) -> None:
        ...
...
class TranslationError(AppCommandError):
    ...
    """
    def __init__(self, *msg: str, string: Optional[Union[str, locale_str]] = ..., locale: Optional[Locale] = ..., context: TranslationContextTypes) -> None:
        ...
