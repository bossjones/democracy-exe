...
from typing import Any, Callable, Coroutine, Hashable, Optional, TYPE_CHECKING, TypeVar, Union
...
T = TypeVar('T')
if TYPE_CHECKING:
    CooldownFunction = Union[Callable[[Interaction[Any]], Coroutine[Any, Any, T]], Callable[[Interaction[Any]], T],]
__all__ = ('has_role', 'has_any_role', 'has_permissions', 'bot_has_permissions', 'cooldown', 'dynamic_cooldown')
class Cooldown:
