...
from typing import Callable, Iterable, List, Literal, Optional, Sequence, TYPE_CHECKING, Union
...
class Thread(Messageable, Hashable):
    ...
    async def edit(self, *, name: str = ..., archived: bool = ..., locked: bool = ..., invitable: bool = ..., pinned: bool = ..., slowmode_delay: int = ..., auto_archive_duration: ThreadArchiveDuration = ..., applied_tags: Sequence[ForumTag] = ..., reason: Optional[str] = ...) -> Thread:
        """|coro|
    ...
    async def add_tags(self, *tags: Snowflake, reason: Optional[str] = ...) -> None:
        r"""|coro|
    ...
    async def remove_tags(self, *tags: Snowflake, reason: Optional[str] = ...) -> None:
        r"""|coro|
