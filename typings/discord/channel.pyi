...
import datetime
import discord.abc
from typing import Any, AsyncIterator, Callable, Dict, Iterable, List, Literal, Mapping, NamedTuple, Optional, Sequence, TYPE_CHECKING, TypeVar, Union, overload
from .scheduled_event import ScheduledEvent
from .permissions import PermissionOverwrite, Permissions
from .enums import ChannelType, ForumLayoutType, ForumOrderType, PrivacyLevel, VideoQualityMode
...
from .types.channel import CategoryChannel as CategoryChannelPayload, DMChannel as DMChannelPayload, ForumChannel as ForumChannelPayload, ForumTag as ForumTagPayload, GroupDMChannel as GroupChannelPayload, MediaChannel as MediaChannelPayload, NewsChannel as NewsChannelPayload, StageChannel as StageChannelPayload, TextChannel as TextChannelPayload, VoiceChannel as VoiceChannelPayload

"""
This type stub file was generated by pyright.
"""
__all__ = ('TextChannel', 'VoiceChannel', 'StageChannel', 'DMChannel', 'CategoryChannel', 'ForumTag', 'ForumChannel', 'GroupChannel', 'PartialMessageable')
if TYPE_CHECKING:
...
class TextChannel(discord.abc.Messageable, discord.abc.GuildChannel, Hashable):
    ...
    @overload
    async def edit(self, *, reason: Optional[str] = ..., name: str = ..., topic: str = ..., position: int = ..., nsfw: bool = ..., sync_permissions: bool = ..., category: Optional[CategoryChannel] = ..., slowmode_delay: int = ..., default_auto_archive_duration: ThreadArchiveDuration = ..., default_thread_slowmode_delay: int = ..., type: ChannelType = ..., overwrites: Mapping[OverwriteKeyT, PermissionOverwrite] = ...) -> TextChannel:
        ...
...
class StageChannel(VocalGuildChannel):
    ...
    async def create_instance(self, *, topic: str, privacy_level: PrivacyLevel = ..., send_start_notification: bool = ..., scheduled_event: Snowflake = ..., reason: Optional[str] = ...) -> StageInstance:
        """|coro|
    ...
    @overload
    async def edit(self, *, name: str = ..., nsfw: bool = ..., bitrate: int = ..., user_limit: int = ..., position: int = ..., sync_permissions: int = ..., category: Optional[CategoryChannel] = ..., overwrites: Mapping[OverwriteKeyT, PermissionOverwrite] = ..., rtc_region: Optional[str] = ..., video_quality_mode: VideoQualityMode = ..., slowmode_delay: int = ..., reason: Optional[str] = ...) -> StageChannel:
        ...
...
class CategoryChannel(discord.abc.GuildChannel, Hashable):
    ...
    @overload
    async def edit(self, *, name: str = ..., position: int = ..., nsfw: bool = ..., overwrites: Mapping[OverwriteKeyT, PermissionOverwrite] = ..., reason: Optional[str] = ...) -> CategoryChannel:
        ...
...
class ForumTag(Hashable):
    ...
    """
    __slots__ = ...
    def __init__(self, *, name: str, emoji: Optional[EmojiInputType] = ..., moderated: bool = ...) -> None:
        ...
...
class ForumChannel(discord.abc.GuildChannel, Hashable):
    ...
    """
    __slots__ = ...
    def __init__(self, *, state: ConnectionState, guild: Guild, data: Union[ForumChannelPayload, MediaChannelPayload]) -> None:
        ...
    ...
    async def create_tag(self, *, name: str, emoji: Optional[PartialEmoji] = ..., moderated: bool = ..., reason: Optional[str] = ...) -> ForumTag:
        """|coro|
    ...
    async def archived_threads(self, *, limit: Optional[int] = ..., before: Optional[Union[Snowflake, datetime.datetime]] = ...) -> AsyncIterator[Thread]:
