...
import re
from typing import Any, ClassVar, Coroutine, Dict, List, Optional, Sequence, TYPE_CHECKING, Type
...
class ViewStore:
    ...
    async def schedule_dynamic_item_call(self, component_type: int, factory: Type[DynamicItem[Item[Any]]], interaction: Interaction, custom_id: str, match: re.Match[str]) -> None:
        ...
