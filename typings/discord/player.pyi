...
class FFmpegPCMAudio(FFmpegAudio):
    ...
    """
    def __init__(self, source: Union[str, io.BufferedIOBase], *, executable: str = ..., pipe: bool = ..., stderr: Optional[IO[bytes]] = ..., before_options: Optional[str] = ..., options: Optional[str] = ...) -> None:
        ...
...
class AudioPlayer(threading.Thread):
    ...
    def send_silence(self, count: int = ...) -> None:
        ...
