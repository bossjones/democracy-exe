...
from pinecone.models import CollectionList, IndexList, PodSpec, ServerlessSpec

class Pinecone:
    def __init__(self, api_key: Optional[str] = ..., host: Optional[str] = ..., proxy_url: Optional[str] = ..., proxy_headers: Optional[Dict[str, str]] = ..., ssl_ca_certs: Optional[str] = ..., ssl_verify: Optional[bool] = ..., config: Optional[Config] = ..., additional_headers: Optional[Dict[str, str]] = ..., pool_threads: Optional[int] = ..., index_api: Optional[ManageIndexesApi] = ..., **kwargs) -> None:
        """
    ...
    def create_index(self, name: str, dimension: int, spec: Union[Dict, ServerlessSpec, PodSpec], metric: Optional[str] = ..., timeout: Optional[int] = ...): # -> None:
    ...
    def configure_index(self, name: str, replicas: Optional[int] = ..., pod_type: Optional[str] = ...): # -> None:
