...
class ServerlessSpec(ModelNormal):
    ...
    def __init__(self, cloud, region, *args, **kwargs) -> None:
        ...
        Args:
            ...
            region (str): The region where you would like your index to be created.  Serverless indexes can be created only in the us-west-2 region of AWS at this time.
