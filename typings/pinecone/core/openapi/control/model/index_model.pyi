...
from pinecone.core.openapi.shared.model_utils import ModelNormal, cached_property, convert_js_args_to_python_args
...
class IndexModel(ModelNormal):
    ...
    def __init__(self, name, dimension, host, spec, status, *args, **kwargs) -> None:
        ...
        Keyword Args:
            metric (str): The distance metric to be used for similarity search. You can use 'euclidean', 'cosine', or 'dotproduct'.. defaults to "cosine", must be one of ["cosine", "euclidean", "dotproduct", ]  # noqa: E501
