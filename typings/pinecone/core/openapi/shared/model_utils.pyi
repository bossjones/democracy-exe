...
def composed_model_input_classes(cls): # -> list[type[ModelSimple] | type[list[Any]] | type[float] | type[int] | type[bool] | type[str] | file_type] | list[type[ModelNormal]] | list[Any]:
    """
