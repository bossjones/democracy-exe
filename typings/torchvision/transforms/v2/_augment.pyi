...
class RandomErasing(_RandomApplyTransform):
    ...
    def __init__(self, p: float = ..., scale: Sequence[float] = ..., ratio: Sequence[float] = ..., value: float = ..., inplace: bool = ...) -> None:
        ...
    


class _BaseMixUpCutMix(Transform):
    def __init__(self, *, alpha: float = ..., num_classes: Optional[int] = ..., labels_getter=...) -> None:
        ...
