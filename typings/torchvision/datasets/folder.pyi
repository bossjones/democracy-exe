...
class ImageFolder(DatasetFolder):
    ...
    """
    def __init__(self, root: Union[str, Path], transform: Optional[Callable] = ..., target_transform: Optional[Callable] = ..., loader: Callable[[str], Any] = ..., is_valid_file: Optional[Callable[[str], bool]] = ..., allow_empty: bool = ...) -> None:
        ...
