...
class Logger:
    ...
    """
    def __init__(self, core, exception, depth, record, lazy, colors, raw, capture, patchers, extra) -> None:
        ...
    
    def __repr__(self): # -> str:
        ...
    
    def add(self, sink, *, level=..., format=..., filter=..., colorize=..., serialize=..., backtrace=..., diagnose=..., enqueue=..., context=..., catch=..., **kwargs):
    ...
    def catch(self, exception=..., *, level=..., reraise=..., onerror=..., exclude=..., default=..., message=...): # -> Catcher:
    ...
    def opt(self, *, exception=..., record=..., lazy=..., colors=..., raw=..., capture=..., depth=..., ansi=...): # -> Logger:
    ...
    def contextualize(__self, **kwargs): # -> Generator[None, Any, None]:
    ...
    def level(self, name, no=..., color=..., icon=...): # -> Level:
    ...
    def configure(self, *, handlers=..., levels=..., extra=..., patcher=..., activation=...): # -> list[Any]:
    ...
    @staticmethod
    def parse(file, pattern, *, cast=..., chunk=...): # -> Generator[Any, Any, None]:
