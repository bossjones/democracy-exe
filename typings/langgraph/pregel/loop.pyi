...
class PregelLoop(LoopProtocol):
    ...
    def accept_push(self, task: PregelExecutableTask, write_idx: int, call: Optional[Call] = ...) -> Optional[PregelExecutableTask]:
...
class SyncPregelLoop(PregelLoop, ContextManager):
    def __init__(self, input: Optional[Any], *, stream: Optional[StreamProtocol], config: RunnableConfig, store: Optional[BaseStore], checkpointer: Optional[BaseCheckpointSaver], nodes: Mapping[str, PregelNode], specs: Mapping[str, Union[BaseChannel, ManagedValueSpec]], manager: Union[None, AsyncParentRunManager, ParentRunManager] = ..., interrupt_after: Union[All, Sequence[str]] = ..., interrupt_before: Union[All, Sequence[str]] = ..., output_keys: Union[str, Sequence[str]] = ..., stream_keys: Union[str, Sequence[str]] = ..., check_subgraphs: bool = ..., debug: bool = ...) -> None:
        ...
...
class AsyncPregelLoop(PregelLoop, AsyncContextManager):
    def __init__(self, input: Optional[Any], *, stream: Optional[StreamProtocol], config: RunnableConfig, store: Optional[BaseStore], checkpointer: Optional[BaseCheckpointSaver], nodes: Mapping[str, PregelNode], specs: Mapping[str, Union[BaseChannel, ManagedValueSpec]], interrupt_after: Union[All, Sequence[str]] = ..., interrupt_before: Union[All, Sequence[str]] = ..., manager: Union[None, AsyncParentRunManager, ParentRunManager] = ..., output_keys: Union[str, Sequence[str]] = ..., stream_keys: Union[str, Sequence[str]] = ..., check_subgraphs: bool = ..., debug: bool = ...) -> None:
        ...
