...
class Call:
    ...
    def __init__(self, func: Callable, input: Any, *, retry: Optional[RetryPolicy]) -> None:
        ...
...
def prepare_single_task(task_path: tuple[Any, ...], task_id_checksum: Optional[str], *, checkpoint: Checkpoint, pending_writes: Sequence[PendingWrite], processes: Mapping[str, PregelNode], channels: Mapping[str, BaseChannel], managed: ManagedValueMapping, config: RunnableConfig, step: int, for_execution: bool, store: Optional[BaseStore] = ..., checkpointer: Optional[BaseCheckpointSaver] = ..., manager: Union[None, ParentRunManager, AsyncParentRunManager] = ...) -> Union[None, PregelTask, PregelExecutableTask]:
