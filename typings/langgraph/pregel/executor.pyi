...
from typing import AsyncContextManager, Awaitable, Callable, ContextManager, Coroutine, Optional, Protocol, TypeVar
...
class Submit(Protocol[P, T]):
    def __call__(self, fn: Callable[P, T], *args: P.args, __name__: Optional[str] = ..., __cancel_on_exit__: bool = ..., __reraise_on_exit__: bool = ..., __next_tick__: bool = ..., **kwargs: P.kwargs) -> concurrent.futures.Future[T]:
        ...
...
class BackgroundExecutor(ContextManager):
    ...
    def submit(self, fn: Callable[P, T], *args: P.args, __name__: Optional[str] = ..., __cancel_on_exit__: bool = ..., __reraise_on_exit__: bool = ..., __next_tick__: bool = ..., **kwargs: P.kwargs) -> concurrent.futures.Future[T]:
        ...
...
class AsyncBackgroundExecutor(AsyncContextManager):
    ...
    def submit(self, fn: Callable[P, Awaitable[T]], *args: P.args, __name__: Optional[str] = ..., __cancel_on_exit__: bool = ..., __reraise_on_exit__: bool = ..., __next_tick__: bool = ..., **kwargs: P.kwargs) -> asyncio.Task[T]:
        ...
