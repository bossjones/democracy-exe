...
from typing import Any, AsyncIterator, Callable, Iterable, Iterator, Optional, Sequence, Union
...
class PregelRunner:
    ...
    def __init__(self, *, submit: Submit, put_writes: Callable[[str, Sequence[tuple[str, Any]]], None], schedule_task: Callable[[PregelExecutableTask, int, Optional[Call]], Optional[PregelExecutableTask]], use_astream: bool = ..., node_finished: Optional[Callable[[str], None]] = ...) -> None:
        ...
    ...
    def commit(self, task: PregelExecutableTask, fut: Union[None, concurrent.futures.Future[Any], asyncio.Future[Any]], exception: Optional[BaseException] = ...) -> None:
        ...
