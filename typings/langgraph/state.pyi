...
class StateGraph(Graph):
    ...
    def add_sequence(self, nodes: Sequence[Union[RunnableLike, tuple[str, RunnableLike]]]) -> Self:
...
class CompiledStateGraph(CompiledGraph):
    ...
    def attach_branch(self, start: str, name: str, branch: Branch, *, with_reader: bool = ...) -> None:
        ...
