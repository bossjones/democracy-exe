...
class ToolNode(RunnableCallable):
    ...
    """
    name: str = ...
    def __init__(self, tools: Sequence[Union[BaseTool, Callable]], *, name: str = ..., tags: Optional[list[str]] = ..., handle_tool_errors: Union[bool, str, Callable[..., str], tuple[type[Exception], ...]] = ..., messages_key: str = ...) -> None:
        ...
...
def tools_condition(state: Union[list[AnyMessage], dict[str, Any], BaseModel], messages_key: str = ...) -> Literal["tools", "__end__"]:
