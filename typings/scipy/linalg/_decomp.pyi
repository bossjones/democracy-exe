...
def eig(a, b=..., left=..., right=..., overwrite_a=..., overwrite_b=..., check_finite=..., homogeneous_eigvals=...): # -> NDArray[Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
    """
...
_conv_dict = ...
def eig_banded(a_band, lower=..., eigvals_only=..., overwrite_a_band=..., select=..., select_range=..., max_ev=..., check_finite=...): # -> tuple[Any, Any]:
    """
...
def eigvals(a, b=..., overwrite_a=..., check_finite=..., homogeneous_eigvals=...): # -> NDArray[Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any]:
    """
...
def eigvals_banded(a_band, lower=..., overwrite_a_band=..., select=..., select_range=..., check_finite=...): # -> tuple[Any, Any]:
    """
    Solve real symmetric or complex Hermitian band matrix eigenvalue problem.
...
def eigvalsh_tridiagonal(d, e, select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[floating[_64Bit]] | tuple[NDArray[Any] | NDArray[floating[_64Bit]], NDArray[floating[_64Bit]]] | tuple[Any, Any]:
    """
...
def eigh_tridiagonal(d, e, eigvals_only=..., select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[floating[_64Bit]] | tuple[NDArray[Any] | NDArray[floating[_64Bit]], NDArray[floating[_64Bit]]] | tuple[Any, Any]:
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[floating[_64Bit]] | NDArray[Any], NDArray[float64]] | NDArray[floating[_64Bit]] | NDArray[Any] | tuple[NDArray[Any], Any]:
    """
