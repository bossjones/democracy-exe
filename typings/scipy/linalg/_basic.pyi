...
def solve_triangular(a, b, trans=..., lower=..., unit_diagonal=..., overwrite_b=..., check_finite=...):
    """
...
def solve_banded(l_and_u, ab, b, overwrite_ab=..., overwrite_b=..., check_finite=...): # -> Any:
    """
...
def solve_toeplitz(c_or_cr, b, check_finite=...): # -> ndarray[Any, dtype[Any]]:
...
def det(a, overwrite_a=..., check_finite=...): # -> float64 | NDArray[floating[_64Bit]] | NDArray[Any] | complex128:
    """
...
def pinv(a, *, atol=..., rtol=..., return_rank=..., check_finite=..., cond=..., rcond=...): # -> tuple[Any, Any]:
    """
...
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[Any, tuple[NDArray[Any], NDArray[signedinteger[Any]]]] | tuple[Any, ndarray[Any, dtype[Any]]]:
    """
