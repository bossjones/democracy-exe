...
def pickle_function(func): # -> tuple[Callable[..., MethodType | ModuleType | Any], tuple[Any | None, Any | None, Any | None]]:
    ...
...
def all_of_type(arg_type): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[Dispatchable, ...]]]:
    """
...
def wrap_single_convertor(convert_single): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], _NotImplementedType | list[Any]]:
    """
...
def wrap_single_convertor_instance(convert_single): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], _NotImplementedType | list[Any]]:
    """
    Wraps a ``__ua_convert__`` defined for a single element to all elements.
    If any of them return ``NotImplemented``, the operation is assumed to be
    undefined.
