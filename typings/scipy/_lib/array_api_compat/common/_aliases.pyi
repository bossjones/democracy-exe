...
def sum(x: ndarray, /, xp, *, axis: Optional[Union[int, Tuple[int, ...]]] = ..., dtype: Optional[Dtype] = ..., keepdims: bool = ..., **kwargs) -> ndarray:
    ...

def prod(x: ndarray, /, xp, *, axis: Optional[Union[int, Tuple[int, ...]]] = ..., dtype: Optional[Dtype] = ..., keepdims: bool = ..., **kwargs) -> ndarray:
    ...
