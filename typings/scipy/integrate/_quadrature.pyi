...
__all__ = ['fixed_quad', 'quadrature', 'romberg', 'romb', 'trapezoid', 'trapz', 'simps', 'simpson', 'cumulative_trapezoid', 'cumtrapz', 'newton_cotes', 'qmc_quad', 'AccuracyWarning', 'cumulative_simpson']
...
def vectorize1(func, args=..., vec_func=...): # -> Callable[..., Any]:
...
@_deprecated("`scipy.integrate.quadrature` is deprecated as of SciPy 1.12.0" "and will be removed in SciPy 1.15.0. Please use" "`scipy.integrate.quad` instead.")
def quadrature(func, a, b, args=..., tol=..., rtol=..., maxiter=..., vec_func=..., miniter=...): # -> tuple[Any | float, Any | float]:
    """
...
def cumulative_simpson(y, *, x=..., dx=..., axis=..., initial=...): # -> NDArray[bool_ | floating[Any]]:
    r"""
...
@_deprecated("`scipy.integrate.romberg` is deprecated as of SciPy 1.12.0" "and will be removed in SciPy 1.15.0. Please use" "`scipy.integrate.quad` instead.")
...
_builtincoeffs = ...
def newton_cotes(rn, equal=...): # -> tuple[Any, Any]:
    r"""
