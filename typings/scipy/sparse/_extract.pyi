...
def find(A): # -> tuple[Any | ndarray[Any, dtype[Any]], Any | ndarray[Any, dtype[Any]], ndarray[Any, dtype[float_]] | ndarray[Any, Any] | Any | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float64]]]:
