...
def splev(x, tck, der=..., ext=...): # -> ndarray[Any, dtype[complexfloating[_64Bit, _64Bit] | floating[_64Bit]]] | list[list[list[Any] | Any] | Any]:
    """
...
def splint(a, b, tck, full_output=...): # -> list[list[list[Any] | tuple[Any, Any] | Any] | tuple[Any, Any] | Any] | tuple[Any, ...] | Any | tuple[Any, Any]:
    """
...
def insert(x, tck, m=..., per=...): # -> BSpline | tuple[Any, list[Any], Any] | tuple[Any, Any, Any]:
    """
...
def splder(tck, n=...): # -> BSpline | tuple[Any, Any, Any]:
    """
...
def splantider(tck, n=...): # -> BSpline | tuple[Any, Any, Any]:
    """
