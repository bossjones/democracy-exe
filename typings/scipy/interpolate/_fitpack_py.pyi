...
def splev(x, tck, der=..., ext=...): # -> ndarray[Any, dtype[complexfloating[_64Bit, _64Bit] | floating[_64Bit]]] | list[Any]:
    """
...
def splint(a, b, tck, full_output=...): # -> list[Any] | tuple[Any, ...] | Any | tuple[Any, Any]:
    """
