...
LEASTSQ_SUCCESS = ...
LEASTSQ_FAILURE = ...
def leastsq(func, x0, args=..., Dfun=..., full_output=..., col_deriv=..., ftol=..., xtol=..., gtol=..., maxfev=..., epsfcn=..., factor=..., diag=...): # -> tuple[Any, int | Any]:
    """
...
def fixed_point(func, x0, args=..., xtol=..., maxiter=..., method=...):
    """
