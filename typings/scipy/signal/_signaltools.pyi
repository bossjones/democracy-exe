...
_modedict = ...
_boundarydict = ...
def correlate(in1, in2, mode=..., method=...): # -> NDArray[bool_] | NDArray[Any]:
    r"""
...
def fftconvolve(in1, in2, mode=..., axes=...): # -> NDArray[bool_] | NDArray[Any]:
...
def oaconvolve(in1, in2, mode=..., axes=...): # -> NDArray[bool_] | NDArray[Any]:
...
def convolve(in1, in2, mode=..., method=...): # -> NDArray[bool_] | NDArray[Any]:
    """
...
def medfilt2d(input, kernel_size=...):
    """
...
_msg_cplx_sort = ...
def cmplx_sort(p): # -> tuple[NDArray[Any], NDArray[intp]]:
    ...
...
def invres(r, p, k, tol=..., rtype=...): # -> tuple[Any | Literal[0], NDArray[Any] | NDArray[bool_]]:
...
def invresz(r, p, k, tol=..., rtype=...): # -> tuple[Any, NDArray[Any] | NDArray[bool_]]:
...
def resample_poly(x, up, down, axis=..., window=..., padtype=..., cval=...): # -> NDArray[Any] | NDArray[bool_] | ndarray[Any, dtype[Any]]:
    """
...
def filtfilt(b, a, x, axis=..., padtype=..., padlen=..., method=..., irlen=...): # -> NDArray[Any]:
    """
...
def decimate(x, q, n=..., ftype=..., axis=..., zero_phase=...): # -> ndarray[Any, dtype[Any]] | ndarray[Any, dtype[bool_]]:
    """
