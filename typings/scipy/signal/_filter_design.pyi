...
def sosfreqz(sos, worN=..., whole=..., fs=...): # -> tuple[Any | NDArray[floating[Any]], float | Any | NDArray[floating[Any]]]:
    r"""
...
def zpk2tf(z, p, k): # -> tuple[ndarray[Any, _dtype] | Any, ndarray[Any, _dtype]]:
    r"""
...
def zpk2sos(z, p, k, pairing=..., *, analog=...):
