...
from . import _basic, _orthogonal, _ufuncs, add_newdocs, basic, orthogonal, sf_error, specfun, spfun_stats
from ._ufuncs import *
from ._support_alternative_backends import chdtrc, entr, erf, erfc, expit, gammainc, gammaincc, gammaln, i0, i0e, i1, i1e, log_ndtr, logit, ndtr, ndtri, rel_entr, xlogy
from ._basic import *
...
__all__ += ['SpecialFunctionWarning', 'SpecialFunctionError', 'logsumexp', 'softmax', 'log_softmax', 'multigammaln', 'ellip_harm', 'ellip_harm_2', 'ellip_normal', 'lambertw', 'spherical_jn', 'spherical_yn', 'spherical_in', 'spherical_kn']
test = ...
_depr_msg = ...
