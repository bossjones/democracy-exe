...
class orthopoly1d(numpy.poly1d):
    def __init__(self, roots: numpy.typing.ArrayLike, weights: numpy.typing.ArrayLike | None, hn: float = ..., kn: float = ..., wfunc=..., limits=..., monic: bool = ..., eval_func: numpy.ufunc = ...) -> None:
        ...
    ...
    @overload
    def __call__(self, x: numpy.poly1d) -> numpy.poly1d:
        ...
