...
def linkage(y, method=..., metric=..., optimal_ordering=...): # -> Any:
    """
...
class ClusterNode:
    ...
    def pre_order(self, func=...): # -> list[Any]:
        """
...
_cnode_bare = ...
_cnode_type = ...
def cut_tree(Z, n_clusters=..., height=...): # -> Any:
    """
...
def to_tree(Z, rd=...): # -> tuple[ClusterNode | None, Any] | ClusterNode | None:
    """
...
def optimal_leaf_ordering(Z, y, metric=...): # -> Any:
    """
...
def cophenet(Z, Y=...): # -> Any | tuple[Any, Any]:
    """
...
def is_valid_im(R, warning=..., throw=..., name=...): # -> bool:
...
def is_valid_linkage(Z, warning=..., throw=..., name=...): # -> bool:
    """
...
def fcluster(Z, t, criterion=..., depth=..., R=..., monocrit=...): # -> Any:
    """
...
def fclusterdata(X, t, criterion=..., metric=..., depth=..., method=..., R=...): # -> Any:
    """
...
def dendrogram(Z, p=..., truncate_mode=..., color_threshold=..., get_leaves=..., orientation=..., labels=..., count_sort=..., distance_sort=..., show_leaf_counts=..., no_plot=..., no_labels=..., leaf_font_size=..., leaf_rotation=..., leaf_label_func=..., show_contracted=..., link_color_func=..., ax=..., above_threshold_color=...): # -> dict[str, Any]:
    """
