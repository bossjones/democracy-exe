...
class MaxentClassifier(ClassifierI):
    ...
    """
    def __init__(self, encoding, weights, logarithmic=...) -> None:
        """
...
class FunctionBackedMaxentFeatureEncoding(MaxentFeatureEncodingI):
    ...
    """
    def __init__(self, func, length, labels) -> None:
        """
...
class GISEncoding(BinaryMaxentFeatureEncoding):
    ...
    training algorithm:
      ...
      - The feature vector must sum to a constant non-negative number
        for every token.
    """
    def __init__(self, labels, mapping, unseen_features=..., alwayson_features=..., C=...) -> None:
        """
...
def calculate_empirical_fcount(train_toks, encoding): # -> NDArray[Any]:
    ...

def calculate_estimated_fcount(classifier, train_toks, encoding): # -> NDArray[Any]:
    ...

def train_maxent_classifier_with_iis(train_toks, trace=..., encoding=..., labels=..., **cutoffs):
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
...
def calculate_nfmap(train_toks, encoding): # -> dict[Any, int]:
    """
...
def calculate_deltas(train_toks, classifier, unattested, ffreq_empirical, nfmap, nfarray, nftranspose, encoding): # -> NDArray[Any]:
    r"""
...
def train_maxent_classifier_with_megam(train_toks, trace=..., encoding=..., labels=..., gaussian_prior_sigma=..., **kwargs): # -> MaxentClassifier:
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
...
def maxent_pos_tagger(): # -> ClassifierBasedPOSTagger:
    ...
