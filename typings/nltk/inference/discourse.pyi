...
class ReadingCommand(metaclass=ABCMeta):
    @abstractmethod
    def parse_to_readings(self, sentence): # -> None:
        """
...
class DrtGlueReadingCommand(ReadingCommand):
    def __init__(self, semtype_file=..., remove_duplicates=..., depparser=...) -> None:
        """
...
class DiscourseTester:
    ...
    """
    def __init__(self, input, reading_command=..., background=...) -> None:
        """
