...
def cities2table(filename, rel_name, dbname, verbose=..., setup=...): # -> None:
    """
...
def sql_query(dbname, query): # -> Cursor:
    """
...
def unary_concept(label, subj, records): # -> Concept:
    """
...
def binary_concept(label, closures, subj, obj, records): # -> Concept:
    """
...
def label_indivs(valuation, lexicon=...):
    """
