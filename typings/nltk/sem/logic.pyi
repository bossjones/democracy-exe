...
def skolem_function(univ_scope=...): # -> IndividualVariableExpression | FunctionVariableExpression | EventVariableExpression | ConstantExpression | ApplicationExpression:
    """
...
EVENT_TYPE = ...
ANY_TYPE = ...
def read_type(type_string): # -> ComplexType | EntityType | TruthValueType | AnyType:
    ...
