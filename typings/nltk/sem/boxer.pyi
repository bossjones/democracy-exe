...
class Boxer:
    ...
    def interpret_sents(self, inputs, discourse_ids=..., question=..., verbose=...): # -> list[Any]:
        """
        Use Boxer to give a first order representation.
    ...
    def interpret_multi_sents(self, inputs, discourse_ids=..., question=..., verbose=...): # -> list[Any]:
        """
        Use Boxer to give a first order representation.
...
class AbstractBoxerDrs:
    def variables(self): # -> tuple[set[Any], set[Any], set[Any]]:
        """
        :return: (set<variables>, set<events>, set<propositions>)
        """
        ...
    
    def variable_types(self): # -> dict[Any, Any]:
        ...
