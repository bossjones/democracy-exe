...
class MultiListbox(Frame):
    ...
    LABEL_CONFIG = ...
    LISTBOX_CONFIG = ...
    def __init__(self, master, columns, column_weights=..., cnf=..., **kw) -> None:
        """
...
class Table:
    ...
    :ivar _rows: A list-of-lists used to hold the cell values of this
        ...
        cell values, one for each column in the row.
    """
    def __init__(self, master, column_names, rows=..., column_weights=..., scrollbar=..., click_to_sort=..., reprfunc=..., cnf=..., **kw) -> None:
        """
    ...
    columnconfig = ...
    itemconfig = ...
    def insert(self, row_index, rowvalue): # -> None:
        """
