...
class CFG:
    ...
    def productions(self, lhs=..., rhs=..., empty=...): # -> Any | dict_values | list:
        """
...
class FeatureGrammar(CFG):
    ...
    def productions(self, lhs=..., rhs=..., empty=...): # -> list | Any:
        """
        Return the grammar productions, filtered by the left-hand side
        or the first item in the right-hand side.
...
_TERMINAL_RE = ...
_DISJUNCTION_RE = ...
def read_grammar(input, nonterm_parser, probabilistic=..., encoding=...): # -> tuple[Any, list]:
    """
