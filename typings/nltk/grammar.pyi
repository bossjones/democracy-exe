...
class Nonterminal:
    ...
    def __div__(self, rhs): # -> Nonterminal:
        """
    ...
    def __truediv__(self, rhs): # -> Nonterminal:
        """
        Return a new nonterminal whose symbol is ``A/B``, where ``A`` is
        the symbol for this nonterminal, and ``B`` is the symbol for rhs.
...
def nonterminals(symbols): # -> list[Nonterminal]:
    """
...
class FeatStructNonterminal(FeatDict, Nonterminal):
    ...
    def symbol(self): # -> Self:
        ...
    


def is_nonterminal(item): # -> bool:
    """
...
class CFG:
    ...
    """
    def __init__(self, start, productions, calculate_leftcorners=...) -> None:
        """
    ...
    @classmethod
    def fromstring(cls, input, encoding=...): # -> Self:
        """
    ...
    def productions(self, lhs=..., rhs=..., empty=...): # -> Any | dict_values[Any, Any] | list[Any]:
        """
    ...
    def leftcorners(self, cat): # -> set[Any]:
        """
    ...
    def is_leftcorner(self, cat, left): # -> bool:
        """
    ...
    def is_flexible_chomsky_normal_form(self): # -> bool:
        """
    ...
    def chomsky_normal_form(self, new_token_padding=..., flexible=...): # -> Self | CFG:
        """
    ...
    @classmethod
    def remove_unitary_rules(cls, grammar): # -> CFG:
        """
    ...
    @classmethod
    def binarize(cls, grammar, padding=...): # -> CFG:
        """
    ...
    @classmethod
    def eliminate_start(cls, grammar): # -> CFG:
        """
...
class FeatureGrammar(CFG):
    ...
    @classmethod
    def fromstring(cls, input, features=..., logic_parser=..., fstruct_reader=..., encoding=...): # -> Self:
        """
    ...
    def productions(self, lhs=..., rhs=..., empty=...): # -> list[Any] | Any:
        """
        Return the grammar productions, filtered by the left-hand side
        or the first item in the right-hand side.
...
class DependencyGrammar:
    ...
    @classmethod
    def fromstring(cls, input): # -> Self:
        ...
    
    def contains(self, head, mod): # -> bool:
        """
...
def induce_pcfg(start, productions): # -> PCFG:
    r"""
...
_TERMINAL_RE = ...
_DISJUNCTION_RE = ...
def read_grammar(input, nonterm_parser, probabilistic=..., encoding=...): # -> tuple[Any, list[Any]]:
    """
...
def standard_nonterm_parser(string, pos): # -> tuple[Nonterminal, int]:
    ...
