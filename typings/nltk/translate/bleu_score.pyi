...
def modified_precision(references, hypothesis, n): # -> Fraction:
    """
...
def closest_ref_length(references, hyp_len): # -> int:
    """
...
def brevity_penalty(closest_ref_len, hyp_len): # -> float | Literal[1, 0]:
    """
...
class SmoothingFunction:
    ...
    """
    def __init__(self, epsilon=..., alpha=..., k=...) -> None:
        """
