...
class StackDecoder:
    ...
    """
    def __init__(self, phrase_table, language_model) -> None:
        """
...
class _Hypothesis:
    ...
    """
    def __init__(self, raw_score=..., src_phrase_span=..., trg_phrase=..., previous=..., future_score=...) -> None:
        """
...
class _Stack:
    ...
    """
    def __init__(self, max_size=..., beam_threshold=...) -> None:
        """
