...
def sentence_ribes(references, hypothesis, alpha=..., beta=...): # -> float | Any:
    """
...
def corpus_ribes(list_of_references, hypotheses, alpha=..., beta=...): # -> float | Any:
    """
...
def position_of_ngram(ngram, sentence): # -> int | None:
    """
...
def find_increasing_sequences(worder): # -> Generator[tuple[None, ...], Any, None]:
    """
...
def kendall_tau(worder, normalize=...): # -> float | Literal[-1]:
    """
...
def spearman_rho(worder, normalize=...): # -> float:
    """
