...
def align_log_prob(i, j, source_sents, target_sents, alignment, params): # -> float:
...
def split_at(it, split_value): # -> Generator[Generator[Any, Any, None], Any, NoReturn]:
...
def parse_token_stream(stream, soft_delimiter, hard_delimiter): # -> list[list[int]]:
