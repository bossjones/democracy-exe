...
class ConcordanceSearchView:
    ...
    def words_and_labels(self, sentence, pos1, pos2): # -> tuple[list[Any], list[Any]]:
        ...
    
    def pad(self, sent, hstart, hend): # -> tuple[Any, Any, Any]:
        ...
...
class ConcordanceSearchModel:
    ...
    def non_default_corpora(self): # -> list[Any]:
        ...
