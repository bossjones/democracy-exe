...
from nltk.chunk.util import ChunkScore, accuracy, conllstr2tree, conlltags2tree, ieerstr2tree, tagstr2tree, tree2conllstr, tree2conlltags
...
:var CHUNK_TAG_PATTERN: A regular expression to test whether a tag
     pattern is valid.
"""
def ne_chunker(fmt=...): # -> Maxent_NE_Chunker:
    """
    Load NLTK's currently recommended named entity chunker.
    """
    ...

def ne_chunk(tagged_tokens, binary=...): # -> Tree:
    """
...
def ne_chunk_sents(tagged_sentences, binary=...): # -> Generator[Any | Generator[Any, None, None] | Iterator[Any], None, None]:
    """
