...
"""
def spearman_correlation(ranks1, ranks2): # -> float:
...
def ranks_from_sequence(seq): # -> Generator[tuple[Any, int], None, None]:
    """Given a sequence, yields each element with an increasing rank, suitable
    for use as an argument to ``spearman_correlation``.
    """
    ...

def ranks_from_scores(scores, rank_gap=...): # -> Generator[tuple[Any, int], Any, None]:
