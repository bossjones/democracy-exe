...
def edge_closure(tree, children=..., maxdepth=..., verbose=...): # -> Generator[tuple[Any, Any], Any, None]:
    """
...
def acyclic_depth_first(tree, children=..., depth=..., cut_mark=..., traversed=..., verbose=...): # -> list[Any]:
    """
    :param tree: the tree root
    :param children: a function taking as argument a tree node
...
def acyclic_branches_depth_first(tree, children=..., depth=..., cut_mark=..., traversed=..., verbose=...): # -> list[Any]:
    """
    :param tree: the tree root
    :param children: a function taking as argument a tree node
    :param depth: the maximum depth of the search
...
def acyclic_dic2tree(node, dic): # -> list[Any]:
    """
...
def unweighted_minimum_spanning_dict(tree, children=...): # -> dict[Any, Any]:
    """
    :param tree: the tree root
    :param children: a function taking as argument a tree node
...
def unweighted_minimum_spanning_tree(tree, children=...): # -> list[Any]:
    """
    :param tree: the tree root
    :param children: a function taking as argument a tree node
...
def unique_list(xs): # -> list[Any]:
    ...

def invert_dict(d): # -> defaultdict[Any, list[Any]]:
    ...

def transitive_closure(graph, reflexive=...): # -> dict[Any, set[Any]]:
    """
...
def invert_graph(graph): # -> dict[Any, Any]:
    """
...
def pad_sequence(sequence, n, pad_left=..., pad_right=..., left_pad_symbol=..., right_pad_symbol=...): # -> chain[Any]:
    """
...
def ngrams(sequence, n, **kwargs): # -> Generator[tuple[Any, ...], Any, None]:
    """
...
def bigrams(sequence, **kwargs): # -> Generator[tuple[Any, ...], Any, None]:
    """
...
def trigrams(sequence, **kwargs): # -> Generator[tuple[Any, ...], Any, None]:
    """
...
def everygrams(sequence, min_len=..., max_len=..., pad_left=..., pad_right=..., **kwargs): # -> Generator[tuple[None, ...], Any, None]:
    """
...
def parallelize_preprocess(func, iterator, processes, progress_bar=...): # -> map[Any] | Generator[Any | None, Any, None] | list[Any | None]:
    ...
