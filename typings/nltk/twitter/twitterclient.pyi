...
class Streamer(TwythonStreamer):
    ...
    def filter(self, track=..., follow=..., lang=...): # -> None:
        """
...
class Query(Twython):
    ...
    def expand_tweetids(self, ids_f, verbose=...): # -> chain[Any]:
        """
    ...
    def search_tweets(self, keywords, limit=..., lang=..., max_id=..., retries_after_twython_exception=...): # -> Generator[Any, Any, None]:
        """
    ...
    def user_info_from_id(self, userids): # -> list[Any]:
        """
    ...
    def user_tweets(self, screen_name, limit, include_rts=...): # -> None:
        """
...
class Twitter:
    ...
    def tweets(self, keywords=..., follow=..., to_screen=..., stream=..., limit=..., date_limit=..., lang=..., repeat=..., gzip_compress=...): # -> None:
        """
