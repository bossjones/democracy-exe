...
if sys.platform.startswith("win"):
    ...
    ...
def gzip_open_unicode(filename, mode=..., compresslevel=..., encoding=..., fileobj=..., errors=..., newline=...): # -> TextIOWrapper[GzipFile | Any]:
    ...

def split_resource_url(resource_url): # -> tuple[Any | Literal['nltk', 'file'], Any | str]:
    """
...
def normalize_resource_url(resource_url): # -> str:
    r"""
...
def normalize_resource_name(resource_name, allow_relative=..., relative_path=...): # -> str:
    """
...
_resource_cache = ...
def find(resource_name, paths=...): # -> ZipFilePathPointer | GzipFileSystemPathPointer | FileSystemPathPointer:
    """
...
def retrieve(resource_url, filename=..., verbose=...): # -> None:
    """
...
FORMATS = ...
AUTO_FORMATS = ...
def restricted_pickle_load(string): # -> Any:
    """
    Prevents any class or function from loading.
    """
    ...

def switch_punkt(lang=...): # -> PunktTokenizer:
    """
...
def switch_chunker(fmt=...): # -> Maxent_NE_Chunker:
    """
...
def switch_t_tagger(): # -> ClassifierBasedPOSTagger:
    """
...
def switch_p_tagger(lang): # -> PerceptronTagger:
    """
...
def show_cfg(resource_url, escape=...): # -> None:
    """
