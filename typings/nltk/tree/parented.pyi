...
class AbstractParentedTree(Tree, metaclass=ABCMeta):
    ...
    if hasattr(list, "__getslice__"):
        def __getslice__(self, start, stop): # -> list[Any] | Self:
            ...
    ...
    def __getnewargs__(self): # -> tuple[Any, list[Any]]:
...
class MultiParentedTree(AbstractParentedTree):
    ...
    def left_siblings(self): # -> list[Any]:
        """
    ...
    def right_siblings(self): # -> list[Any]:
        """
    ...
    def parent_indices(self, parent): # -> list[Any] | list[int]:
        """
    ...
    def treepositions(self, root): # -> list[tuple[()]] | list[Any]:
        """
