...
"""
def load_parser(grammar_url, trace=..., parser=..., chart_class=..., beam_size=..., **load_args): # -> InsideChartParser | FeatureChartParser | ChartParser:
    """
...
def taggedsent_to_conll(sentence): # -> Generator[LiteralString, Any, None]:
    """
...
def taggedsents_to_conll(sentences): # -> Generator[LiteralString | Literal['\n\n'], Any, None]:
    """
