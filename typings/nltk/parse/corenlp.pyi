...
class GenericCoreNLPParser(ParserI, TokenizerI, TaggerI):
    ...
    def parse_sents(self, sentences, *args, **kwargs): # -> Generator[Iterator[Any], Any, None]:
    ...
    def raw_parse(self, sentence, properties=..., *args, **kwargs): # -> Iterator[Any]:
        """Parse a sentence.
    ...
    def raw_parse_sents(self, sentences, verbose=..., properties=..., *args, **kwargs): # -> Generator[Iterator[Any], Any, None]:
        """Parse multiple sentences.
