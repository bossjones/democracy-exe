...
class TreeEdge(EdgeI):
    ...
    """
    def __init__(self, span, lhs, rhs, dot=...) -> None:
        """
    ...
    @staticmethod
    def from_production(production, index): # -> TreeEdge:
        """
    ...
    def move_dot_forward(self, new_end): # -> TreeEdge:
        """
...
class LeafEdge(EdgeI):
    ...
    position is ``0``.
    """
    def __init__(self, leaf, index) -> None:
        """
...
class Chart:
    ...
    def iteredges(self): # -> Iterator[Any]:
        """
    ...
    def select(self, **restrictions): # -> Iterator[Any]:
        """
    ...
    def insert_with_backpointer(self, new_edge, previous_edge, child_edge): # -> bool:
        """
        Add a new edge to the chart, using a pointer to the previous edge.
        """
        ...
    
    def insert(self, edge, *child_pointer_lists): # -> bool:
        """
    ...
    def parses(self, root, tree_class=...): # -> Generator[Any, Any, None]:
        """
    ...
    def trees(self, edge, tree_class=..., complete=...): # -> Iterator[Any]:
        """
    ...
    def pretty_format_edge(self, edge, width=...):
        """
    ...
    def pretty_format_leaves(self, width=...): # -> Literal['|.|', '']:
        """
    ...
    def pretty_format(self, width=...): # -> LiteralString:
        """
    ...
    def dot_digraph(self): # -> LiteralString | str:
        ...
...
class AbstractChartRule(ChartRuleI):
    ...
    def apply_everywhere(self, chart, grammar): # -> Generator[Any, Any, None]:
        ...
...
class FundamentalRule(AbstractChartRule):
    ...
    """
    NUM_EDGES = ...
    def apply(self, chart, grammar, left_edge, right_edge): # -> Generator[Any, Any, None]:
        ...
...
class SingleEdgeFundamentalRule(FundamentalRule):
    ...
    """
    NUM_EDGES = ...
    def apply(self, chart, grammar, edge): # -> Generator[Any, Any, None]:
        ...
...
class LeafInitRule(AbstractChartRule):
    NUM_EDGES = ...
    def apply(self, chart, grammar): # -> Generator[LeafEdge, Any, None]:
        ...
...
class TopDownInitRule(AbstractChartRule):
    ...
    """
    NUM_EDGES = ...
    def apply(self, chart, grammar): # -> Generator[TreeEdge, Any, None]:
        ...
...
class TopDownPredictRule(AbstractChartRule):
    ...
    """
    NUM_EDGES = ...
    def apply(self, chart, grammar, edge): # -> Generator[TreeEdge, Any, None]:
        ...
...
class ChartParser(ParserI):
    ...
    """
    def __init__(self, grammar, strategy=..., trace=..., trace_chart_width=..., use_agenda=..., chart_class=...) -> None:
        """
    ...
    def chart_parse(self, tokens, trace=...): # -> Chart:
        """
    ...
    def parse(self, tokens, tree_class=...): # -> Generator[Any, Any, None]:
        ...
...
class SteppingChartParser(ChartParser):
    ...
    """
    def __init__(self, grammar, strategy=..., trace=...) -> None:
        ...
    ...
    def step(self): # -> Generator[Any | None, Any, NoReturn]:
        """
    ...
    def current_chartrule(self): # -> None:
        "Return the chart rule used to generate the most recent edge."
        ...
    
    def parses(self, tree_class=...): # -> Generator[Any, Any, None]:
...
def demo_grammar(): # -> CFG:
    ...

def demo(choice=..., print_times=..., print_grammar=..., print_trees=..., trace=..., sent=..., numparses=...): # -> None:
    """
