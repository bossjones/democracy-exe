...
from nltk.parse.chart import BottomUpPredictCombineRule, BottomUpPredictRule, CachedTopDownPredictRule, Chart, ChartParser, EmptyPredictRule, FundamentalRule, SingleEdgeFundamentalRule, TopDownInitRule, TreeEdge
...
class FeatureTreeEdge(TreeEdge):
    ...
    """
    def __init__(self, span, lhs, rhs, dot=..., bindings=...) -> None:
        """
    ...
    @staticmethod
    def from_production(production, index): # -> FeatureTreeEdge:
        """
    ...
    def move_dot_forward(self, new_end, bindings=...): # -> FeatureTreeEdge:
        """
    ...
    def next_with_bindings(self): # -> FeatStructNonterminal:
        ...
    
    def bindings(self): # -> dict[Any, Any]:
        """
        Return a copy of this edge's bindings dictionary.
        """
        ...
    
    def variables(self): # -> set[Any] | None:
        """
...
class FeatureChart(Chart):
    ...
    def parses(self, start, tree_class=...): # -> Generator[Any, Any, None]:
        ...
...
class FeatureFundamentalRule(FundamentalRule):
    ...
    """
    def apply(self, chart, grammar, left_edge, right_edge): # -> Generator[FeatureTreeEdge, Any, None]:
        ...
...
class FeatureTopDownInitRule(TopDownInitRule):
    def apply(self, chart, grammar): # -> Generator[FeatureTreeEdge, Any, None]:
        ...
...
class FeatureTopDownPredictRule(CachedTopDownPredictRule):
    ...
    """
    def apply(self, chart, grammar, edge): # -> Generator[FeatureTreeEdge, Any, None]:
        ...
...
class InstantiateVarsChart(FeatureChart):
    ...
    def insert(self, edge, child_pointer_list): # -> bool:
        ...
    ...
    def inst_vars(self, edge): # -> dict[Any, Variable]:
        ...
    


def demo_grammar(): # -> FeatureGrammar:
    ...

def demo(print_times=..., print_grammar=..., print_trees=..., print_sentence=..., trace=..., parser=..., sent=...): # -> None:
    ...
