...
class IncrementalChart(Chart):
    ...
    def iteredges(self): # -> Generator[Any, None, None]:
        ...
...
class IncrementalChartParser(ChartParser):
    ...
    def chart_parse(self, tokens, trace=...): # -> IncrementalChart:
        ...
...
def demo(print_times=..., print_grammar=..., print_trees=..., trace=..., sent=..., numparses=...): # -> None:
    """
