...
class SequentialBackoffTagger(TaggerI):
    ...
    def tag(self, tokens): # -> list[tuple]:
        ...
...
class NgramTagger(ContextTagger):
    ...
    def context(self, tokens, index, history): # -> tuple[tuple, Any]:
        ...
...
class AffixTagger(ContextTagger):
    ...
    def encode_json_obj(self): # -> tuple[int, int, Any | dict, Self | Any | None]:
        ...
...
class RegexpTagger(SequentialBackoffTagger):
    ...
    def encode_json_obj(self): # -> tuple[list[tuple], Self | Any | None]:
        ...
