...
class TagRule(metaclass=ABCMeta):
    ...
    """
    def __init__(self, original_tag, replacement_tag) -> None:
        ...
    
    def apply(self, tokens, positions=...): # -> list[int | Any]:
        """
    ...
    @abstractmethod
    def applies(self, tokens, index): # -> None:
        """
...
class Rule(TagRule):
    ...
    """
    json_tag = ...
    def __init__(self, templateid, original_tag, replacement_tag, conditions) -> None:
        """
    ...
    def encode_json_obj(self): # -> dict[str, Any]:
        ...
    ...
    def applies(self, tokens, index): # -> bool:
        ...
