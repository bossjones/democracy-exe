...
class NombankInstance:
    ...
    tree = ...
    @staticmethod
    def parse(s, parse_fileid_xform=..., parse_corpus=...): # -> NombankInstance:
        ...
...
class NombankTreePointer(NombankPointer):
    ...
    @staticmethod
    def parse(s): # -> NombankChainTreePointer | NombankSplitTreePointer | NombankTreePointer:
        ...
