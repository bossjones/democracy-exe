...
class Lemma(_WordNetObject):
    ...
    def derivationally_related_forms(self): # -> list:
        ...

    def pertainyms(self): # -> list:
        ...
...
class Synset(_WordNetObject):
    ...
    def lemma_names(self, lang=...): # -> list:
        """Return all the lemma_names associated with the synset"""
        ...

    def lemmas(self, lang=...): # -> list | None:
        """Return all the lemma objects associated with the synset"""
        ...

    def root_hypernyms(self): # -> list:
 ...
 Synset('physical_entity.n.01'), Synset('entity.n.01')]
    ...
    def tree(self, rel, depth=..., cut_mark=...): # -> list:
        """
    ...
    def lowest_common_hypernyms(self, other, simulate_root=..., use_min_depth=...): # -> list[Self | Any] | list:
        """
...
class WordNetCorpusReader(CorpusReader):
    ...
    def index_sense(self, version=...): # -> dict:
        """Read sense key to synset id mapping from index.sense file in corpus directory"""
        ...

    def map_to_many(self, version=...): # -> dict:
        ...

    def map_to_one(self, version=...): # -> dict:
        ...

    def map_wn(self, version=...): # -> dict | None:
    ...
    def synsets(self, lemma, pos=..., lang=..., check_exceptions=...): # -> list[Any | None] | list:
    ...
    def lemmas(self, lemma, pos=..., lang=...): # -> list:
        """Return all Lemma objects with a name matching the specified lemma
        name and part of speech tag. Matches any part of speech tag if none is
        specified."""
        ...

    def all_lemma_names(self, pos=..., lang=...): # -> Iterator | Generator[Any, None, None]:
    ...
    def words(self, lang=...): # -> Iterator | Generator[Any, None, None]:
        """return lemmas of the given language as list of words"""
        ...

    def synonyms(self, word, lang=...): # -> list[list]:
    ...
    def ic(self, corpus, weight_senses_equally=..., smoothing=...): # -> dict:
        """
