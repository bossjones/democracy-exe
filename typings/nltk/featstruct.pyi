...
class FeatStruct(SubstituteBindingsI):
    ...
    def retract_bindings(self, bindings): # -> Self:
...
def find_variables(fstruct, fs_class=...): # -> set[Any] | None:
    """
...
def conflicts(fstruct1, fstruct2, trace=...): # -> list[Any]:
    """
...
class RangeFeature(Feature):
    ...
    def unify_base_values(self, fval1, fval2, bindings): # -> _UnificationFailure | tuple[Any, Any]:
        ...
...
class FeatStructReader:
    ...
    _BARE_PREFIX_RE = ...
    _START_FDICT_RE = ...
    def read_partial(self, s, position=..., reentrances=..., fstruct=...): # -> tuple[Any, Any] | tuple[Any, int]:
        """
    ...
    VALUE_HANDLERS = ...
    def read_fstruct_value(self, s, position, reentrances, match): # -> tuple[Any, Any] | tuple[Any, int]:
        ...
    ...
    _SYM_CONSTS = ...
    def read_sym_value(self, s, position, reentrances, match): # -> tuple[Any, Any]:
        ...
    ...
    def read_tuple_value(self, s, position, reentrances, match): # -> tuple[Any, Any]:
        ...
    
    def read_set_value(self, s, position, reentrances, match): # -> tuple[Any, Any]:
        ...
