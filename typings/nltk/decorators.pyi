...
OLD_SYS_PATH = ...
def getinfo(func): # -> dict[str, str | list[str] | Signature | tuple[Any, ...] | dict[str, Any] | None]:
    """
...
def update_wrapper(wrapper, model, infodict=...):
    "akin to functools.update_wrapper"
    ...

def new_wrapper(wrapper, model): # -> Any:
    """
...
def decorator(caller): # -> type[Any] | Callable[..., Any]:
    """
...
def getattr_(obj, name, default_thunk): # -> Any:
