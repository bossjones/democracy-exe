...
class MMBTModel(nn.Module, ModuleUtilsMixin):
    ...
    def forward(self, input_modal, input_ids=..., modal_start_tokens=..., modal_end_tokens=..., attention_mask=..., token_type_ids=..., modal_token_type_ids=..., position_ids=..., modal_position_ids=..., head_mask=..., inputs_embeds=..., encoder_hidden_states=..., encoder_attention_mask=..., output_attentions=..., output_hidden_states=..., return_dict=...): # -> BaseModelOutputWithPooling:
        r"""
        Returns:
