...
class MarianConfig(PretrainedConfig):
    ...
    attribute_map = ...
    def __init__(self, vocab_size=..., decoder_vocab_size=..., max_position_embeddings=..., encoder_layers=..., encoder_ffn_dim=..., encoder_attention_heads=..., decoder_layers=..., decoder_ffn_dim=..., decoder_attention_heads=..., encoder_layerdrop=..., decoder_layerdrop=..., use_cache=..., is_encoder_decoder=..., activation_function=..., d_model=..., dropout=..., attention_dropout=..., activation_dropout=..., init_std=..., decoder_start_token_id=..., scale_embedding=..., pad_token_id=..., eos_token_id=..., forced_eos_token_id=..., share_encoder_decoder_embeddings=..., **kwargs) -> None:
        ...
