...
class TFMarianEncoder(keras.layers.Layer):
    config_class = MarianConfig
    def __init__(self, config: MarianConfig, embed_tokens: Optional[keras.layers.Embedding] = ..., **kwargs) -> None:
        ...
    ...
    @unpack_inputs
    def call(self, input_ids: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ...): # -> tuple[Any, ...] | TFBaseModelOutput:
        """
        Args:
...
class TFMarianDecoder(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, input_ids: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., position_ids: tf.Tensor | None = ..., encoder_hidden_states: tf.Tensor | None = ..., encoder_attention_mask: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., cross_attn_head_mask: tf.Tensor | None = ..., past_key_values: Tuple[Tuple[tf.Tensor]] | None = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ...): # -> tuple[Any, tuple[()] | Any | None, Any | tuple[()] | None, tuple[()] | Any | None, tuple[()] | Any | None] | TFBaseModelOutputWithPastAndCrossAttentions:
        r"""
        Args:
            input_ids (`tf.Tensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
...
class TFMarianModel(TFMarianPreTrainedModel):
    ...
    def call(self, input_ids: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., decoder_input_ids: tf.Tensor | None = ..., decoder_attention_mask: tf.Tensor | None = ..., decoder_position_ids: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., decoder_head_mask: tf.Tensor | None = ..., cross_attn_head_mask: tf.Tensor | None = ..., encoder_outputs: tf.Tensor | None = ..., past_key_values: Tuple[Tuple[tf.Tensor]] | None = ..., inputs_embeds: tf.Tensor | None = ..., decoder_inputs_embeds: tf.Tensor | None = ..., use_cache: bool | None = ..., output_attentions: bool | None = ..., output_hidden_states: bool | None = ..., return_dict: bool | None = ..., training: bool = ..., **kwargs) -> Tuple[tf.Tensor] | TFSeq2SeqModelOutput:
        ...
...
class TFMarianMTModel(TFMarianPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(self, input_ids: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., decoder_input_ids: tf.Tensor | None = ..., decoder_attention_mask: tf.Tensor | None = ..., decoder_position_ids: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., decoder_head_mask: tf.Tensor | None = ..., cross_attn_head_mask: tf.Tensor | None = ..., encoder_outputs: TFBaseModelOutput | None = ..., past_key_values: Tuple[Tuple[tf.Tensor]] | None = ..., inputs_embeds: tf.Tensor | None = ..., decoder_inputs_embeds: tf.Tensor | None = ..., use_cache: bool | None = ..., output_attentions: bool | None = ..., output_hidden_states: bool | None = ..., return_dict: bool | None = ..., labels: tf.Tensor | None = ..., training: bool = ...) -> Tuple[tf.Tensor] | TFSeq2SeqLMOutput:
        r"""
