...
class Mask2FormerImageProcessor(BaseImageProcessor):
    ...
    """
    model_input_names = ...
    def __init__(self, do_resize: bool = ..., size: Dict[str, int] = ..., size_divisor: int = ..., resample: PILImageResampling = ..., do_rescale: bool = ..., rescale_factor: float = ..., do_normalize: bool = ..., image_mean: Union[float, List[float]] = ..., image_std: Union[float, List[float]] = ..., ignore_index: Optional[int] = ..., reduce_labels: bool = ..., **kwargs) -> None:
        ...
    ...
    def preprocess(self, images: ImageInput, segmentation_maps: Optional[ImageInput] = ..., instance_id_to_semantic_id: Optional[Dict[int, int]] = ..., do_resize: Optional[bool] = ..., size: Optional[Dict[str, int]] = ..., size_divisor: Optional[int] = ..., resample: PILImageResampling = ..., do_rescale: Optional[bool] = ..., rescale_factor: Optional[float] = ..., do_normalize: Optional[bool] = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., ignore_index: Optional[int] = ..., reduce_labels: Optional[bool] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., data_format: Union[str, ChannelDimension] = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ..., **kwargs) -> BatchFeature:
        ...
