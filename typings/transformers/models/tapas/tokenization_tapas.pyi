...
from ...tokenization_utils_base import BatchEncoding, ENCODE_KWARGS_DOCSTRING, EncodedInput, PreTokenizedInput, TextInput
...
class TapasTokenizer(PreTrainedTokenizer):
    ...
    def get_answer_ids(self, column_ids, row_ids, tokenized_table, answer_texts_question, answer_coordinates_question): # -> list[int]:
        ...
    
    def convert_logits_to_predictions(self, data, logits, logits_agg=..., cell_classification_threshold=...): # -> tuple[list[Any], Any] | tuple[list[Any]]:
        """
