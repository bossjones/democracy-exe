...
class RoCBertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=..., input_shape_ids=..., input_pronunciation_ids=..., token_type_ids=..., position_ids=..., inputs_embeds=..., past_key_values_length=...): # -> Any | Tensor:
        ...
...
class RoCBertForMaskedLM(RoCBertPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, input_shape_ids=..., input_pronunciation_ids=..., attention_mask=..., **model_kwargs): # -> dict[str, Any]:
        ...
...
class RoCBertForCausalLM(RoCBertPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, input_shape_ids=..., input_pronunciation_ids=..., past_key_values=..., attention_mask=..., **model_kwargs): # -> dict[str, Any]:
        ...
