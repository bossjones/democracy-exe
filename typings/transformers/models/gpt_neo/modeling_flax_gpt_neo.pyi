...
class FlaxGPTNeoSelfAttention(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., deterministic: bool = ..., init_cache: bool = ..., output_attentions: bool = ...): # -> tuple[Any, Any] | tuple[Any]:
        ...
...
class FlaxGPTNeoPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: GPTNeoConfig, input_shape: Tuple = ..., seed: int = ..., dtype: jnp.dtype = ..., _do_init: bool = ..., **kwargs) -> None:
        ...
...
class FlaxGPTNeoBlockCollection(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., deterministic: bool = ..., init_cache: bool = ..., output_attentions: bool = ..., output_hidden_states: bool = ..., return_dict: bool = ...): # -> tuple[Any, tuple[()] | Any | None, tuple[()] | Any | None]:
        ...
