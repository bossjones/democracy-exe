...
class VivitModel(VivitPreTrainedModel):
    ...
    def forward(self, pixel_values: Optional[torch.FloatTensor] = ..., head_mask: Optional[torch.FloatTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.FloatTensor], BaseModelOutputWithPooling]:
        r"""
        Returns:
...
class VivitForVideoClassification(VivitPreTrainedModel):
    ...
    def forward(self, pixel_values: Optional[torch.FloatTensor] = ..., head_mask: Optional[torch.FloatTensor] = ..., labels: Optional[torch.LongTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.FloatTensor], ImageClassifierOutput]:
        r"""
