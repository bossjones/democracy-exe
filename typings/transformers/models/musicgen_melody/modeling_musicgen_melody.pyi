...
class MusicgenMelodySinusoidalPositionalEmbedding(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, inputs_embeds: torch.Tensor, past_key_values_length: int = ...): # -> Tensor:
        ...
...
class MusicgenMelodyAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[MusicgenMelodyConfig] = ...) -> None:
        ...
...
class MusicgenMelodyDecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., layer_head_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[Tuple[torch.Tensor]] = ..., output_attentions: Optional[bool] = ..., use_cache: Optional[bool] = ...) -> torch.Tensor:
        """
        Args:
...
class MusicgenMelodyForCausalLM(MusicgenMelodyPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, attention_mask=..., encoder_hidden_states=..., encoder_attention_mask=..., head_mask=..., past_key_values=..., use_cache=..., delay_pattern_mask=..., guidance_scale=..., **kwargs): # -> dict[str, Any]:
        ...
...
class MusicgenMelodyForConditionalGeneration(PreTrainedModel):
    ...
    _supports_flash_attn_2 = ...
    _supports_sdpa = ...
    def __init__(self, config: MusicgenMelodyConfig = ..., text_encoder: Optional[PreTrainedModel] = ..., audio_encoder: Optional[PreTrainedModel] = ..., decoder: Optional[MusicgenMelodyForCausalLM] = ...) -> None:
        ...
    ...
    @replace_return_docstrings(output_type=MusicgenMelodyOutputWithPast, config_class=_CONFIG_FOR_DOC)
    def forward(self, input_ids: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.BoolTensor] = ..., input_features: Optional[torch.FloatTensor] = ..., decoder_input_ids: Optional[torch.LongTensor] = ..., decoder_attention_mask: Optional[torch.BoolTensor] = ..., past_key_values: Tuple[Tuple[torch.FloatTensor]] = ..., encoder_hidden_states: Optional[torch.FloatTensor] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., decoder_inputs_embeds: Optional[torch.FloatTensor] = ..., labels: Optional[torch.LongTensor] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., **kwargs) -> Union[Tuple, MusicgenMelodyOutputWithPast]:
        r"""
        Returns:
    ...
    def prepare_inputs_for_generation(self, decoder_input_ids, encoder_hidden_states=..., past_key_values=..., attention_mask=..., decoder_attention_mask=..., decoder_head_mask=..., use_cache=..., decoder_delay_pattern_mask=..., guidance_scale=..., **kwargs): # -> dict[str, Any]:
        ...
