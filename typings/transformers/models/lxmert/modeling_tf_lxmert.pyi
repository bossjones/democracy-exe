...
class TFLxmertAttention(keras.layers.Layer):
    ...
    def call(self, hidden_states, context, attention_mask, output_attentions, training=...): # -> tuple[Any, Any] | tuple[Any]:
        ...
...
class TFLxmertCrossAttentionLayer(keras.layers.Layer):
    ...
    def call(self, input_tensor, ctx_tensor, ctx_att_mask, output_attentions=..., training=...): # -> tuple[Any, Any] | tuple[Any]:
        ...
...
class TFLxmertXLayer(keras.layers.Layer):
    ...
    def cross_att(self, lang_input, lang_attention_mask, visn_input, visn_attention_mask, output_attentions, training=...): # -> tuple[Any, Any]:
        ...

    def self_att(self, lang_input, lang_attention_mask, visn_input, visn_attention_mask, training=...): # -> tuple[Any, Any]:
        ...

    def output_fc(self, lang_input, visn_input, training=...): # -> tuple[Any, Any]:
        ...

    def call(self, lang_feats, lang_attention_mask, visn_feats, visn_attention_mask, output_attentions, training=...): # -> tuple[Any, Any, Any] | tuple[Any, Any]:
        ...
...
class TFLxmertEncoder(keras.layers.Layer):
    ...
    def call(self, lang_feats=..., lang_attention_mask=..., visual_feats=..., visual_pos=..., visual_attention_mask=..., output_attentions=..., training=...): # -> tuple[tuple[tuple[()] | tuple[Any] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[tuple[()] | tuple[Any] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[()] | tuple[Any] | None]:
        ...
...
class TFLxmertMainLayer(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, input_ids=..., visual_feats=..., visual_pos=..., attention_mask=..., visual_attention_mask=..., token_type_ids=..., inputs_embeds=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=...): # -> tuple[Any, ...] | TFLxmertModelOutput:
        ...
...
class TFLxmertModel(TFLxmertPreTrainedModel):
    ...
    def call(self, input_ids: TFModelInputType | None = ..., visual_feats: tf.Tensor | None = ..., visual_pos: tf.Tensor | None = ..., attention_mask: np.ndarray | tf.Tensor | None = ..., visual_attention_mask: np.ndarray | tf.Tensor | None = ..., token_type_ids: np.ndarray | tf.Tensor | None = ..., inputs_embeds: np.ndarray | tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ...) -> Union[Tuple, TFLxmertModelOutput]:
        ...
...
class TFLxmertForPreTraining(TFLxmertPreTrainedModel):
    ...
    def call(self, input_ids: TFModelInputType | None = ..., visual_feats: tf.Tensor | None = ..., visual_pos: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., visual_attention_mask: tf.Tensor | None = ..., token_type_ids: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., masked_lm_labels: tf.Tensor | None = ..., obj_labels: Dict[str, Tuple[tf.Tensor, tf.Tensor]] | None = ..., matched_label: tf.Tensor | None = ..., ans: tf.Tensor | None = ..., output_attentions: bool | None = ..., output_hidden_states: bool | None = ..., return_dict: bool | None = ..., training: bool = ...) -> Tuple[tf.Tensor] | TFLxmertForPreTrainingOutput:
        r"""
