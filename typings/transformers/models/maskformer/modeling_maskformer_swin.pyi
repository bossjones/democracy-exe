...
class MaskFormerSwinStage(nn.Module):
    ...
    def forward(self, hidden_states, input_dimensions, head_mask=..., output_attentions=..., output_hidden_states=...): # -> tuple[Any, tuple[Any, Any, Any, Any], tuple[()] | tuple[Any, ...] | None]:
        ...
...
class MaskFormerSwinModel(MaskFormerSwinPreTrainedModel):
    ...
    def forward(self, pixel_values=..., head_mask=..., output_attentions=..., output_hidden_states=..., interpolate_pos_encoding=..., return_dict=...): # -> Any | MaskFormerSwinModelOutputWithPooling:
        ...
