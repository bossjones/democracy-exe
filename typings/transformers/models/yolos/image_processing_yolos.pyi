...
class YolosImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, annotations: Optional[Union[AnnotationType, List[AnnotationType]]] = ..., return_segmentation_masks: bool = ..., masks_path: Optional[Union[str, pathlib.Path]] = ..., do_resize: Optional[bool] = ..., size: Optional[Dict[str, int]] = ..., resample=..., do_rescale: Optional[bool] = ..., rescale_factor: Optional[Union[int, float]] = ..., do_normalize: Optional[bool] = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., do_convert_annotations: Optional[bool] = ..., do_pad: Optional[bool] = ..., format: Optional[Union[str, AnnotationFormat]] = ..., return_tensors: Optional[Union[TensorType, str]] = ..., data_format: Union[str, ChannelDimension] = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ..., **kwargs) -> BatchFeature:
        """
