...
from ...modeling_outputs import CausalLMOutputWithCrossAttentions, Seq2SeqLMOutput, Seq2SeqModelOutput, Seq2SeqQuestionAnsweringModelOutput, Seq2SeqSequenceClassifierOutput
...
class BigBirdPegasusDecoderAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[BigBirdPegasusConfig] = ...) -> None:
        ...
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod
    def create_masks_for_block_sparse_attn(attention_mask: torch.Tensor, block_size: int): # -> tuple[Tensor, Tensor, Tensor, Tensor]:
        ...
