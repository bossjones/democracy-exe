...
class IdeficsProcessor(ProcessorMixin):
    ...
    def __call__(self, prompts: Union[List[TextInput], List[List[TextInput]]], padding: Union[bool, str, PaddingStrategy] = ..., truncation: Union[bool, str, TruncationStrategy] = ..., max_length: Optional[int] = ..., transform: Callable = ..., add_eos_token=..., add_end_of_utterance_token=..., debug=..., return_tensors=...) -> BatchEncoding:
