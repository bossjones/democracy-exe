...
class LlavaNextProcessor(ProcessorMixin):
    ...
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]], images: ImageInput = ..., padding: Union[bool, str, PaddingStrategy] = ..., truncation: Union[bool, str, TruncationStrategy] = ..., max_length: Optional[int] = ..., do_pad: Optional[bool] = ..., return_tensors: Optional[Union[str, TensorType]] = ...) -> BatchFeature:
        """
