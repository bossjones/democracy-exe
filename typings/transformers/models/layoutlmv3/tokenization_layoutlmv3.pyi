...
class LayoutLMv3Tokenizer(PreTrainedTokenizer):
    ...
    vocab_files_names = ...
    model_input_names = ...
    def __init__(self, vocab_file, merges_file, errors=..., bos_token=..., eos_token=..., sep_token=..., cls_token=..., unk_token=..., pad_token=..., mask_token=..., add_prefix_space=..., cls_token_box=..., sep_token_box=..., pad_token_box=..., pad_token_label=..., only_label_first_subword=..., **kwargs) -> None:
        ...
