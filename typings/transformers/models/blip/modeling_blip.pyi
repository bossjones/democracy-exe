...
class BlipModel(BlipPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(BLIP_VISION_INPUTS_DOCSTRING)
    def get_image_features(self, pixel_values: Optional[torch.FloatTensor] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ...) -> torch.FloatTensor:
        r"""
        Returns:
    ...
    def get_multimodal_features(self, input_ids: Optional[torch.LongTensor] = ..., pixel_values: Optional[torch.FloatTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ...) -> torch.FloatTensor:
        r"""
        Returns:
...
class BlipForQuestionAnswering(BlipPreTrainedModel):
    ...
    @torch.no_grad()
    def generate(self, input_ids: torch.LongTensor, pixel_values: torch.FloatTensor, attention_mask: Optional[torch.LongTensor] = ..., interpolate_pos_encoding: bool = ..., **generate_kwargs) -> torch.LongTensor:
        r"""
        Overrides *generate* function to be able to use the model as a conditional generator
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(BLIP_VISION_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=BlipTextVisionModelOutput, config_class=BlipVisionConfig)
    def forward(self, input_ids: torch.LongTensor, pixel_values: torch.FloatTensor, use_itm_head: Optional[bool] = ..., attention_mask: Optional[torch.LongTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ...) -> Union[Tuple, BlipTextVisionModelOutput]:
        r"""
        Returns:
