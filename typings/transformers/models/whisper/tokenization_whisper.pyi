...
class WhisperTokenizer(PreTrainedTokenizer):
    ...
    vocab_files_names = ...
    model_input_names = ...
    def __init__(self, vocab_file, merges_file, normalizer_file=..., errors=..., unk_token=..., bos_token=..., eos_token=..., pad_token=..., add_prefix_space=..., language=..., task=..., predict_timestamps=..., **kwargs) -> None:
        ...
