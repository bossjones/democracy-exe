...
class InformerAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[InformerConfig] = ...) -> None:
        ...
...
class InformerProbSparseAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., sampling_factor: int = ..., bias: bool = ...) -> None:
        ...
