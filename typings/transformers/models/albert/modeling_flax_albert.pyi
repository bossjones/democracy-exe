...
class FlaxAlbertLayerCollection(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask, deterministic: bool = ..., output_attentions: bool = ..., output_hidden_states: bool = ...): # -> tuple[Any | tuple[()] | tuple[Any], ...] | tuple[Any, ...] | tuple[Any, tuple[()] | tuple[Any, ...] | tuple[Any]] | tuple[Any]:
        ...
...
class FlaxAlbertLayerCollections(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask, deterministic: bool = ..., output_attentions: bool = ..., output_hidden_states: bool = ...): # -> tuple[Any | tuple[()] | tuple[Any, ...] | tuple[Any], ...] | tuple[Any, ...] | tuple[Any, tuple[()] | tuple[Any, ...] | tuple[Any]] | tuple[Any]:
        ...
