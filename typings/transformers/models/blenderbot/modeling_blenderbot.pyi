...
class BlenderbotDecoder(BlenderbotPreTrainedModel):
    ...
    def get_input_embeddings(self): # -> Embedding | BlenderbotScaledWordEmbedding | Module:
        ...
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> PreTrainedModel:
        ...
