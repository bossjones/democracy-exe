...
class TFBlenderbotEncoder(keras.layers.Layer):
    config_class = BlenderbotConfig
    def __init__(self, config: BlenderbotConfig, embed_tokens: Optional[keras.layers.Embedding] = ..., **kwargs) -> None:
        ...
...
class TFBlenderbotModel(TFBlenderbotPreTrainedModel):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Any, dict[str, Any]] | tuple[TFBlenderbotSmallModel, dict[str, Any]] | TFBlenderbotSmallModel | tuple[Self, dict[str, Any]] | Self:
        ...
...
class TFBlenderbotForConditionalGeneration(TFBlenderbotPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs): # -> tuple[Any, dict[str, Any]] | tuple[TFBlenderbotSmallForConditionalGeneration, dict[str, Any]] | TFBlenderbotSmallForConditionalGeneration | tuple[Self, dict[str, Any]] | Self:
        ...
