...
class FlaxLongT5LocalAttention(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., key_value_states=..., position_bias=..., output_attentions=..., deterministic=...): # -> tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]]:
        """
        Self-attention (if key_value_states is None) or attention over source sentence (provided by key_value_states).
        """
        ...
...
class FlaxLongT5TransientGlobalAttention(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., key_value_states=..., position_bias=..., output_attentions=..., deterministic=...): # -> tuple[Any, Any, Any] | tuple[Any, Any]:
        """
        Self-attention (if key_value_states is None) or attention over source sentence (provided by key_value_states).
        """
        ...
...
class FlaxLongT5LayerLocalSelfAttention(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., output_attentions=..., deterministic=..., **kwargs: Any): # -> tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]]:
        ...
...
class FlaxLongT5LayerTransientGlobalSelfAttention(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., output_attentions=..., deterministic=..., **kwargs: Any): # -> tuple[Any, Any, Any] | tuple[Any, Any]:
        ...
...
class FlaxLongT5Block(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., encoder_hidden_states=..., encoder_attention_mask=..., encoder_decoder_position_bias=..., output_attentions=..., return_dict=..., deterministic=..., init_cache=...): # -> tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any | ndarray[Any, Any], ...]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any, ...]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any], Any] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any, Any] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any]:
        ...
...
class FlaxLongT5LayerCollection(nn.Module):
    ...
    def __call__(self, hidden_states, attention_mask=..., position_bias=..., encoder_hidden_states=..., encoder_attention_mask=..., encoder_decoder_position_bias=..., output_attentions=..., deterministic=..., init_cache=...): # -> tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any | ndarray[Any, Any], ...]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], *tuple[Any, ...]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any], Any] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any | ndarray[Any, Any]] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any, Any] | tuple[tuple[Any, Any | ndarray[Any, Any], Any] | tuple[Any, Any | ndarray[Any, Any]] | tuple[Any, Any, Any] | tuple[Any, Any], Any]:
        ...
...
class FlaxLongT5PreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: LongT5Config, input_shape: Tuple[int] = ..., seed: int = ..., dtype: jnp.dtype = ..., _do_init: bool = ..., **kwargs) -> None:
        ...
