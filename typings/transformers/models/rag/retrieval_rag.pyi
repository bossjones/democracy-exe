...
class CanonicalHFIndex(HFIndexBase):
    ...
    """
    def __init__(self, vector_size: int, dataset_name: str = ..., dataset_split: str = ..., index_name: Optional[str] = ..., index_path: Optional[str] = ..., use_dummy_dataset=..., dataset_revision=...) -> None:
        ...
