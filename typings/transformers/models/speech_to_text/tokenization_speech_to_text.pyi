...
class Speech2TextTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, spm_file, bos_token=..., eos_token=..., pad_token=..., unk_token=..., do_upper_case=..., do_lower_case=..., tgt_lang=..., lang_codes=..., additional_special_tokens=..., sp_model_kwargs: Optional[Dict[str, Any]] = ..., **kwargs) -> None:
        ...
