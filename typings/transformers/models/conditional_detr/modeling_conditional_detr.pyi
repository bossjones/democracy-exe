...
def build_position_encoding(config): # -> ConditionalDetrSinePositionEmbedding | ConditionalDetrLearnedPositionEmbedding:
    ...
...
class ConditionalDetrAttention(nn.Module):
    ...
    different to v.
    """
    def __init__(self, embed_dim: int, out_dim: int, num_heads: int, dropout: float = ..., bias: bool = ...) -> None:
        ...

    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., key_states: Optional[torch.Tensor] = ..., value_states: Optional[torch.Tensor] = ..., output_attentions: bool = ...) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        """Input shape: Batch x Time x Channel"""
        ...
...
class ConditionalDetrEncoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: torch.Tensor, object_queries: torch.Tensor = ..., output_attentions: bool = ..., **kwargs): # -> tuple[Tensor, Any] | tuple[Tensor]:
        """
        Args:
...
class ConditionalDetrDecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., object_queries: Optional[torch.Tensor] = ..., query_position_embeddings: Optional[torch.Tensor] = ..., query_sine_embed: Optional[torch.Tensor] = ..., encoder_hidden_states: Optional[torch.Tensor] = ..., encoder_attention_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ..., is_first: Optional[bool] = ..., **kwargs): # -> tuple[Tensor, Any, Any | None] | tuple[Tensor]:
        """
        Args:
...
class ConditionalDetrEncoder(ConditionalDetrPreTrainedModel):
    ...
    def forward(self, inputs_embeds=..., attention_mask=..., object_queries=..., output_attentions=..., output_hidden_states=..., return_dict=..., **kwargs): # -> tuple[Any, ...] | BaseModelOutput:
        r"""
        Args:
...
class ConditionalDetrModel(ConditionalDetrPreTrainedModel):
    ...
    def forward(self, pixel_values: torch.FloatTensor, pixel_mask: Optional[torch.LongTensor] = ..., decoder_attention_mask: Optional[torch.LongTensor] = ..., encoder_outputs: Optional[torch.FloatTensor] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., decoder_inputs_embeds: Optional[torch.FloatTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.FloatTensor], ConditionalDetrModelOutput]:
        r"""
        Returns:
...
class ConditionalDetrForObjectDetection(ConditionalDetrPreTrainedModel):
    ...
    def forward(self, pixel_values: torch.FloatTensor, pixel_mask: Optional[torch.LongTensor] = ..., decoder_attention_mask: Optional[torch.LongTensor] = ..., encoder_outputs: Optional[torch.FloatTensor] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., decoder_inputs_embeds: Optional[torch.FloatTensor] = ..., labels: Optional[List[dict]] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.FloatTensor], ConditionalDetrObjectDetectionOutput]:
        r"""
