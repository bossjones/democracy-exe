...
def build_string_from_input(prompt, bos_token, image_seq_len, image_token): # -> str:
    """
...
class PaliGemmaProcessor(ProcessorMixin):
    ...
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., images: ImageInput = ..., tokenize_newline_separately: bool = ..., padding: Union[bool, str, PaddingStrategy] = ..., truncation: Union[bool, str, TruncationStrategy] = ..., max_length=..., return_tensors: Optional[Union[str, TensorType]] = ..., do_resize: bool = ..., do_normalize: bool = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., data_format: Optional[ChannelDimension] = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ..., resample: PILImageResampling = ..., do_convert_rgb: bool = ..., do_thumbnail: bool = ..., do_align_long_axis: bool = ..., do_rescale: bool = ..., suffix: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ...) -> BatchFeature:
        """
