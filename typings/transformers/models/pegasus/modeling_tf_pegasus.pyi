...
class TFPegasusEncoder(keras.layers.Layer):
    config_class = PegasusConfig
    def __init__(self, config: PegasusConfig, embed_tokens: Optional[keras.layers.Embedding] = ..., **kwargs) -> None:
        ...
    ...
    @unpack_inputs
    def call(self, input_ids: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: Optional[bool] = ...): # -> tuple[Any, ...] | TFBaseModelOutput:
        """
        Args:
...
class TFPegasusDecoder(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, input_ids: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., attention_mask: tf.Tensor | None = ..., position_ids: tf.Tensor | None = ..., encoder_hidden_states: tf.Tensor | None = ..., encoder_attention_mask: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., cross_attn_head_mask: tf.Tensor | None = ..., past_key_values: Tuple[Tuple[tf.Tensor]] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: Optional[bool] = ...): # -> tuple[Any, tuple[()] | Any | None, Any | tuple[()] | None, tuple[()] | Any | None, tuple[()] | Any | None] | TFBaseModelOutputWithPastAndCrossAttentions:
        r"""
        Args:
            input_ids (`tf.Tensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
