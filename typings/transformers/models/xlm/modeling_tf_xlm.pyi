...
class TFXLMMainLayer(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, input_ids=..., attention_mask=..., langs=..., token_type_ids=..., position_ids=..., lengths=..., cache=..., head_mask=..., inputs_embeds=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=...) -> Union[TFBaseModelOutput, Tuple[tf.Tensor]]:
        ...
...
class TFXLMModel(TFXLMPreTrainedModel):
    ...
    def call(self, input_ids: TFModelInputType | None = ..., attention_mask: tf.Tensor | None = ..., langs: tf.Tensor | None = ..., token_type_ids: tf.Tensor | None = ..., position_ids: tf.Tensor | None = ..., lengths: tf.Tensor | None = ..., cache: Dict[str, tf.Tensor] | None = ..., head_mask: tf.Tensor | None = ..., inputs_embeds: tf.Tensor | None = ..., output_attentions: bool | None = ..., output_hidden_states: bool | None = ..., return_dict: bool | None = ..., training: bool = ...) -> TFBaseModelOutput | Tuple[tf.Tensor]:
        ...
