...
class MinNewTokensLengthLogitsProcessor(LogitsProcessor):
    ...
    ```
    """
    def __init__(self, prompt_length_to_skip: int, min_new_tokens: int, eos_token_id: Union[int, List[int], torch.Tensor], device: str = ...) -> None:
        ...
...
class EtaLogitsWarper(LogitsProcessor):
    ...
    ```
    """
    def __init__(self, epsilon: float, filter_value: float = ..., min_tokens_to_keep: int = ..., device: str = ...) -> None:
        ...
...
class ExponentialDecayLengthPenalty(LogitsProcessor):
    ...
    ```
    """
    def __init__(self, exponential_decay_length_penalty: Tuple[int, float], eos_token_id: Union[int, List[int], torch.Tensor], input_ids_seq_length: int) -> None:
        ...
...
class WatermarkLogitsProcessor(LogitsProcessor):
    ...
    ```
    """
    def __init__(self, vocab_size, device, greenlist_ratio: float = ..., bias: float = ..., hashing_key: int = ..., seeding_scheme: str = ..., context_width: int = ...) -> None:
        ...
...
class SynthIDTextWatermarkLogitsProcessor(LogitsProcessor):
    ...
    * **Utility Functions:** Provides functions to compute g-values directly, check for context repetition, create
    ...
    ```
    """
    def __init__(self, ngram_len: int, keys: List[int], sampling_table_size: int, sampling_table_seed: int, context_history_size: int, device: torch.device, skip_first_ngram_calls: bool = ..., debug_mode: bool = ...) -> None:
        ...
    ...
    def accumulate_hash(self, current_hash: torch.LongTensor, data: torch.LongTensor, multiplier: int = ..., increment: int = ...) -> torch.LongTensor:
        """
