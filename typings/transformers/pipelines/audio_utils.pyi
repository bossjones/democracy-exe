...
def ffmpeg_microphone(sampling_rate: int, chunk_length_s: float, format_for_conversion: str = ..., ffmpeg_input_device: Optional[str] = ...): # -> Generator[bytes, Any, None]:
    """
...
def ffmpeg_microphone_live(sampling_rate: int, chunk_length_s: float, stream_chunk_s: Optional[int] = ..., stride_length_s: Optional[Union[Tuple[float, float], float]] = ..., format_for_conversion: str = ..., ffmpeg_input_device: Optional[str] = ...): # -> Generator[dict[str, Any], Any, None]:
    """
