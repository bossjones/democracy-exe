...
def evaluate_lambda(lambda_expression, state, static_tools, custom_tools): # -> Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | Callable[..., ...] | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None]:
    ...

def evaluate_while(while_loop, state, static_tools, custom_tools): # -> None:
    ...

def create_function(func_def, state, static_tools, custom_tools): # -> Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | ... | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None]:
    ...
...
def evaluate_subscript(subscript, state, static_tools, custom_tools): # -> Series[Any] | ndarray[Any, Any] | str:
    ...

def evaluate_name(name, state, static_tools, custom_tools): # -> Any:
    ...

def evaluate_condition(condition, state, static_tools, custom_tools): # -> bool | Series[Any]:
    ...
...
def evaluate_ast(expression: ast.AST, state: Dict[str, Any], static_tools: Dict[str, Callable], custom_tools: Dict[str, Callable], authorized_imports: List[str] = ...): # -> list[Any] | Any | tuple[Any, ...] | bool | Series[Any] | Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | ... | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None:
    """
...
def evaluate_python_code(code: str, static_tools: Optional[Dict[str, Callable]] = ..., custom_tools: Optional[Dict[str, Callable]] = ..., state: Optional[Dict[str, Any]] = ..., authorized_imports: List[str] = ...): # -> list[Any] | Any | tuple[Any, ...] | bool | Series[Any] | Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | ... | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None:
    """
