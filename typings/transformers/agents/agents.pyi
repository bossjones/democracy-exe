...
class CodeAgent(Agent):
    ...
    def run(self, task: str, return_generated_code: bool = ..., **kwargs): # -> str | list[Any] | Any | tuple[Any, ...] | bool | Series[Any] | Callable[..., Any | list[Any] | tuple[Any, ...] | bool | Series[Any] | ... | Callable[..., Any] | dict[Any, Any] | str | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None] | Callable[..., Any] | dict[Any, Any] | ndarray[Any, Any] | slice[int | Any, int | Any, int | Any] | set[Any] | None:
        """
