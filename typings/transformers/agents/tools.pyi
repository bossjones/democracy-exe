...
class Tool:
    ...
    @classmethod
    def from_hub(cls, repo_id: str, model_repo_id: Optional[str] = ..., token: Optional[str] = ..., **kwargs): # -> Any:
        """
...
def get_tool_description_with_args(tool: Tool, description_template: str = ...) -> str:
    ...

@lru_cache
def compile_jinja_template(template): # -> Template:
    ...
...
TASK_MAPPING = ...
def load_tool(task_or_repo_id, model_repo_id=..., token=..., **kwargs): # -> Any:
    """
...
class EndpointClient:
    ...
    @staticmethod
    def decode_image(raw_image): # -> ImageFile:
        ...
