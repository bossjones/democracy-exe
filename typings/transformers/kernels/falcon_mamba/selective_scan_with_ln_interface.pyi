...
class MambaInnerFn(torch.autograd.Function):
    ...
    @staticmethod
    @custom_bwd
    def backward(ctx, dout): # -> tuple[Tensor, Any, Any | None, Tensor, Tensor, Tensor, Any | None, Any, Any | None, Any | None, Any | None, Any | None, Any | None, Any | None, None, None, None, None, None, None]:
        ...
