...
def nested_detach(tensors): # -> list[Any] | tuple[Any, ...] | Mapping[Any, Any] | Tensor:
...
class EvalLoopContainer:
    ...
    def get_arrays(self): # -> list[Any] | tuple[Any, ...] | Mapping[Any, Any] | ndarray[Any, Any] | Tensor | NDArray[Any] | None:
