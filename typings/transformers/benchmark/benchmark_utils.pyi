...
from ..utils import is_psutil_available, is_py3nvml_available, is_tf_available, is_torch_available
...
def is_memory_tracing_enabled(): # -> bool:
    ...
...
class Benchmark(ABC):
    ...
    @property
    def print_fn(self): # -> Callable[..., None] | Callable[..., Any]:
        ...
    ...
    @property
    def environment_info(self): # -> dict[Any, Any]:
        ...

    def print_results(self, result_dict, type_label): # -> None:
        ...

    def print_memory_trace_statistics(self, summary: MemorySummary): # -> None:
        ...

    def save_to_csv(self, result_dict, filename): # -> None:
        ...
