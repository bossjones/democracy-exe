...
def squad_convert_example_to_features_init(tokenizer_for_convert: PreTrainedTokenizerBase): # -> None:
    ...

def squad_convert_examples_to_features(examples, tokenizer, max_seq_length, doc_stride, max_query_length, is_training, padding_strategy=..., return_dataset=..., threads=..., tqdm_enabled=...): # -> tuple[list[Any], TensorDataset] | list[Any]:
    """
...
class SquadProcessor(DataProcessor):
    ...
    train_file = ...
    dev_file = ...
    def get_examples_from_dataset(self, dataset, evaluate=...): # -> list[Any]:
        """
