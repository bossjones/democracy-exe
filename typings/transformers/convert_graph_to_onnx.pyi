...
def ensure_valid_input(model, tokens, input_names): # -> tuple[list[Any], tuple[Any, ...]]:
    """
...
def convert(framework: str, model: str, output: Path, opset: int, tokenizer: Optional[str] = ..., use_external_format: bool = ..., pipeline_name: str = ..., **model_kwargs): # -> None:
    """
