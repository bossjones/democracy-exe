...
def enumerate_reversed(iterable, start=..., length=...): # -> zip[tuple[int, Any]] | list[tuple[int, Any]]:
...
def build_duration_func(duration, min=...): # -> Callable[[], float] | partial[float] | Callable[[], float | Any] | None:
    ...

def build_extractor_filter(categories, negate=..., special=...): # -> Callable[..., Literal[True]] | Callable[..., bool]:
