...
"""String formatters"""
NONE = ...
def parse(format_string, default=..., fmt=...): # -> ExpressionFormatter | FStringFormatter | ModuleFormatter | StringFormatter | TemplateFStringFormatter | TemplateFormatter:
    ...
...
class StringFormatter:
    ...
    def format_map(self, kwdict): # -> LiteralString:
...
def parse_field_name(field_name): # -> tuple[Literal['_lit'], tuple[itemgetter[Any]]] | tuple[Any, list[Any]]:
    ...
