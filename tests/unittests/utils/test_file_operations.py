...
from democracy_exe.utils.file_operations import (
...
def mock_pdf_file(tmp_path: Path) -> Path:
    ...
    shutil.copy("democracy_exe/data/chroma/documents/Attack_on_Titan.pdf", test_pdf_path)
...
async def test_details_from_file(mocker: MockerFixture, tmp_path: Path) -> None:
    ...
    mock_shell = mocker.patch("democracy_exe.shell._aio_run_process_and_communicate")
