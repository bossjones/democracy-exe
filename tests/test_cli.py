...
from democracy_exe import cli
from democracy_exe.cli import (
    APP,
    ChromaChoices,
    about,
    deps,
...
class TestApp:
    ...
    def test_load_commands(self) -> None:
        ...
        from democracy_exe.cli import load_commands
    ...
    def test_version_callback(self) -> None:
        ...
        from democracy_exe.cli import version_callback
    ...
    def test_show(self) -> None:
        ...
        assert result.exit_code == 0
        assert "Show democracy_exe" in result.stdout
    ...
    def test_main(self, mocker: MockerFixture) -> None:
        ...
        # Mock load_commands
        mock_load_commands = mocker.patch("democracy_exe.cli.load_commands")
    ...
    def test_run_pyright(self, mocker: MockerFixture) -> None:
        ...
        mock_run_pyright = mocker.patch("democracy_exe.utils.repo_typing.run_pyright")
    ...
    #     # Mock SandboxAgent
    #     mock_democracy_exe = mocker.patch("democracy_exe.cli.SandboxAgent")
    #     mock_bot_instance = mocker.AsyncMock()
    #     mock_democracy_exe.return_value = mock_bot_instance

    #     # Run the function
    #     asyncio.run(run_bot_with_redis())

    #     # Assert that SandboxAgent was called and the bot was started
    #     mock_democracy_exe.assert_called_once()
    ...
    #     mock_democracy_exe = mocker.patch("democracy_exe.cli.SandboxAgent")
    #     mock_democracy_exe.side_effect = Exception("Test exception")
